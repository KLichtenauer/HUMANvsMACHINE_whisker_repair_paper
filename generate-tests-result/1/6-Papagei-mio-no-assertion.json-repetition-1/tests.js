const test0 = async function (t) {
  t.dragSprite('Milch', 8.828396955741326, 51.332470021380544, null);
  ...
  t.assert.withinRange(t.getSprite("Milch").x, 8.828396955741326, 5, "Expected Sprite Milch to have x-position 8.828396955741326 +-5");
  t.assert.withinRange(t.getSprite("Milch").y, 51.332470021380544, 5, "Expected Sprite Milch to have y-position 51.332470021380544 +-5");
  ...
  t.assert.equal(t.getSprite("Baum").layerOrder, 2, "Expected Sprite Baum to be at layer 2");
  t.assert.equal(t.getSprite("Milch").layerOrder, 3, "Expected Sprite Milch to be at layer 3");
  t.assert.withinRange(t.getSprite("Papagei").x, -102.04445042265587, 5, "Expected Sprite Papagei to have x-position -102.04445042265587 +-5");
  t.assert.withinRange(t.getSprite("Papagei").y, -24.470857293848766, 5, "Expected Sprite Papagei to have y-position -24.470857293848766 +-5");
