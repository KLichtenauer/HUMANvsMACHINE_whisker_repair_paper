const test0 = async function (t) {
  ...
  t.assert.equal(t.getSprite("Rot").direction, -46.755031887744366, 1, "Expected Sprite Rot to face in direction -46.755031887744366 +-1");
  t.assert.equal(t.getSprite("Rot").getClone(1).direction, -46.755031887744366, 1, "Expected Clone 1 of Rot to face in direction -46.755031887744366 +-1");
  ...
  t.assert.withinRange(t.getSprite("Rot").x, 185, 5, "Expected Sprite Rot to have x-position 185 +-5");
  t.assert.withinRange(t.getSprite("Rot").y, -174, 5, "Expected Sprite Rot to have y-position -174 +-5");
  t.assert.withinRange(t.getSprite("Rot").getClone(1).x, 113.05555555555556, 5, "Expected Clone 1 of Rot to have x-position 113.05555555555556 +-5");
  ...
  t.assert.withinRange(t.getSprite("Scheibe").x, 0, 5, "Expected Sprite Scheibe to have x-position 0 +-5");
  t.assert.withinRange(t.getSprite("Scheibe").y, 0, 5, "Expected Sprite Scheibe to have y-position 0 +-5");
  t.assert.withinRange(t.getSprite("Rot").x, 91, 5, "Expected Sprite Rot to have x-position 91 +-5");
  t.assert.withinRange(t.getSprite("Rot").y, 15, 5, "Expected Sprite Rot to have y-position 15 +-5");
  t.assert.not(t.getSprite("Scheibe").sayText, "Expected Sprite Scheibe not to say anything");
  t.assert.not(t.getSprite("Rot").sayText, "Expected Sprite Rot not to say anything");
  t.assert.withinRange(t.getSprite("Scheibe").size, 50, 1, "Expected Sprite Scheibe to have size 50 +-1");
  t.assert.withinRange(t.getSprite("Rot").size, 80, 1, "Expected Sprite Rot to have size 80 +-1");
  ...
  t.assert.equal(t.getSprite("Rot").direction, -49.30765135216842, 1, "Expected Sprite Rot to face in direction -49.30765135216842 +-1");
  t.assert.equal(t.getSprite("Rot").getClone(1).direction, -49.30765135216842, 1, "Expected Clone 1 of Rot to face in direction -49.30765135216842 +-1");
  t.assert.equal(t.getSprite("Scheibe").effects.color, 0, "Expected effect color of Sprite Scheibe to be 0");
  t.assert.equal(t.getSprite("Scheibe").effects.fisheye, 0, "Expected effect fisheye of Sprite Scheibe to be 0");
  t.assert.equal(t.getSprite("Scheibe").effects.whirl, 0, "Expected effect whirl of Sprite Scheibe to be 0");
  t.assert.equal(t.getSprite("Scheibe").effects.pixelate, 0, "Expected effect pixelate of Sprite Scheibe to be 0");
  ...
  t.assert.withinRange(t.getSprite("Scheibe").x, 0, 5, "Expected Sprite Scheibe to have x-position 0 +-5");
  t.assert.withinRange(t.getSprite("Scheibe").y, 0, 5, "Expected Sprite Scheibe to have y-position 0 +-5");
  t.assert.withinRange(t.getSprite("Rot").x, 207, 5, "Expected Sprite Rot to have x-position 207 +-5");
  t.assert.withinRange(t.getSprite("Rot").y, -178, 5, "Expected Sprite Rot to have y-position -178 +-5");
  t.assert.withinRange(t.getSprite("Rot").getClone(1).x, 207, 5, "Expected Clone 1 of Rot to have x-position 207 +-5");
  t.assert.withinRange(t.getSprite("Rot").getClone(1).y, -178, 5, "Expected Clone 1 of Rot to have y-position -178 +-5");
  t.assert.not(t.getSprite("Scheibe").sayText, "Expected Sprite Scheibe not to say anything");
  t.assert.not(t.getSprite("Rot").sayText, "Expected Sprite Rot not to say anything");
  t.assert.not(t.getSprite("Rot").getClone(1).sayText, "Expected Clone 1 of Rot not to say anything");
  t.assert.withinRange(t.getSprite("Scheibe").size, 50, 1, "Expected Sprite Scheibe to have size 50 +-1");
  ...
  t.assert.withinRange(t.getSprite("Rot").x, 207, 5, "Expected Sprite Rot to have x-position 207 +-5");
  t.assert.withinRange(t.getSprite("Rot").y, -178, 5, "Expected Sprite Rot to have y-position -178 +-5");
  t.assert.withinRange(t.getSprite("Rot").getClone(1).x, 202.4, 5, "Expected Clone 1 of Rot to have x-position 202.4 +-5");
  t.assert.withinRange(t.getSprite("Rot").getClone(1).y, -174.04444444444445, 5, "Expected Clone 1 of Rot to have y-position -174.04444444444445 +-5");
  t.assert.not(t.getSprite("Scheibe").sayText, "Expected Sprite Scheibe not to say anything");
  t.assert.not(t.getSprite("Rot").sayText, "Expected Sprite Rot not to say anything");
  t.assert.not(t.getSprite("Rot").getClone(1).sayText, "Expected Clone 1 of Rot not to say anything");
  t.assert.withinRange(t.getSprite("Scheibe").size, 50, 1, "Expected Sprite Scheibe to have size 50 +-1");
  ...
  t.assert.withinRange(t.getSprite("Rot").x, 207, 5, "Expected Sprite Rot to have x-position 207 +-5");
  t.assert.withinRange(t.getSprite("Rot").y, -178, 5, "Expected Sprite Rot to have y-position -178 +-5");
  t.assert.withinRange(t.getSprite("Rot").getClone(1).x, 193.2, 5, "Expected Clone 1 of Rot to have x-position 193.2 +-5");
  t.assert.withinRange(t.getSprite("Rot").getClone(1).y, -166.13333333333333, 5, "Expected Clone 1 of Rot to have y-position -166.13333333333333 +-5");
  t.assert.not(t.getSprite("Scheibe").sayText, "Expected Sprite Scheibe not to say anything");
  t.assert.not(t.getSprite("Rot").sayText, "Expected Sprite Rot not to say anything");
  t.assert.not(t.getSprite("Rot").getClone(1).sayText, "Expected Clone 1 of Rot not to say anything");
  t.assert.withinRange(t.getSprite("Scheibe").size, 50, 1, "Expected Sprite Scheibe to have size 50 +-1");
  ...
  t.assert.withinRange(t.getSprite("Rot").x, 207, 5, "Expected Sprite Rot to have x-position 207 +-5");
  t.assert.withinRange(t.getSprite("Rot").y, -178, 5, "Expected Sprite Rot to have y-position -178 +-5");
  t.assert.withinRange(t.getSprite("Rot").getClone(1).x, 188.6, 5, "Expected Clone 1 of Rot to have x-position 188.6 +-5");
  t.assert.withinRange(t.getSprite("Rot").getClone(1).y, -162.17777777777778, 5, "Expected Clone 1 of Rot to have y-position -162.17777777777778 +-5");
  t.assert.not(t.getSprite("Scheibe").sayText, "Expected Sprite Scheibe not to say anything");
  t.assert.not(t.getSprite("Rot").sayText, "Expected Sprite Rot not to say anything");
  t.assert.not(t.getSprite("Rot").getClone(1).sayText, "Expected Clone 1 of Rot not to say anything");
  t.assert.withinRange(t.getSprite("Scheibe").size, 50, 1, "Expected Sprite Scheibe to have size 50 +-1");
  ...
  t.assert.equal(t.getSprite("Rot").volume, 100, "Expected Sprite Rot to have volume 100");
  t.assert.equal(t.getSprite("Rot").getClone(1).volume, 100, "Expected Clone 1 of Rot to have volume 100");
  t.dragSprite('Rot', 51.45761716587061, -16.957638531980948, null);
  await t.runForSteps(1);
  t.assert.equal(t.getStage().currentCostume, 0, "Expected backdrop 0");
  t.assert.equal(t.getSprite("Scheibe").currentCostume, 0, "Expected Sprite Scheibe to have costume 0");
  t.assert.equal(t.getSprite("Rot").currentCostume, 0, "Expected Sprite Rot to have costume 0");
  ...
  t.assert.withinRange(t.getSprite("Scheibe").x, 0, 5, "Expected Sprite Scheibe to have x-position 0 +-5");
  t.assert.withinRange(t.getSprite("Scheibe").y, 0, 5, "Expected Sprite Scheibe to have y-position 0 +-5");
  t.assert.withinRange(t.getSprite("Rot").x, 51.45761716587061, 5, "Expected Sprite Rot to have x-position 51.45761716587061 +-5");
  t.assert.withinRange(t.getSprite("Rot").y, -16.957638531980948, 5, "Expected Sprite Rot to have y-position -16.957638531980948 +-5");
  t.assert.withinRange(t.getSprite("Rot").getClone(1).x, 186.3, 5, "Expected Clone 1 of Rot to have x-position 186.3 +-5");
  t.assert.withinRange(t.getSprite("Rot").getClone(1).y, -160.2, 5, "Expected Clone 1 of Rot to have y-position -160.2 +-5");
  t.assert.not(t.getSprite("Scheibe").sayText, "Expected Sprite Scheibe not to say anything");
  t.assert.not(t.getSprite("Rot").sayText, "Expected Sprite Rot not to say anything");
  t.assert.not(t.getSprite("Rot").getClone(1).sayText, "Expected Clone 1 of Rot not to say anything");
  t.assert.withinRange(t.getSprite("Scheibe").size, 50, 1, "Expected Sprite Scheibe to have size 50 +-1");
  ...
  t.assert.equal(t.getSprite("Rot").volume, 100, "Expected Sprite Rot to have volume 100");
  t.assert.equal(t.getSprite("Rot").getClone(1).volume, 100, "Expected Clone 1 of Rot to have volume 100");
  t.dragSprite('Rot', 45.94900612111709, -47.88015242851201, 1);
  await t.runForSteps(1);
  t.assert.equal(t.getStage().currentCostume, 0, "Expected backdrop 0");
  t.assert.equal(t.getSprite("Scheibe").currentCostume, 0, "Expected Sprite Scheibe to have costume 0");
  t.assert.equal(t.getSprite("Rot").currentCostume, 0, "Expected Sprite Rot to have costume 0");
  ...
  t.assert.withinRange(t.getSprite("Rot").x, 51.45761716587061, 5, "Expected Sprite Rot to have x-position 51.45761716587061 +-5");
  t.assert.withinRange(t.getSprite("Rot").y, -16.957638531980948, 5, "Expected Sprite Rot to have y-position -16.957638531980948 +-5");
  t.assert.withinRange(t.getSprite("Rot").getClone(1).x, 40.84356099654852, 5, "Expected Clone 1 of Rot to have x-position 40.84356099654852 +-5");
  t.assert.withinRange(t.getSprite("Rot").getClone(1).y, -42.56013549201068, 5, "Expected Clone 1 of Rot to have y-position -42.56013549201068 +-5");
  t.assert.not(t.getSprite("Scheibe").sayText, "Expected Sprite Scheibe not to say anything");
  t.assert.not(t.getSprite("Rot").sayText, "Expected Sprite Rot not to say anything");
  t.assert.not(t.getSprite("Rot").getClone(1).sayText, "Expected Clone 1 of Rot not to say anything");
  t.assert.withinRange(t.getSprite("Scheibe").size, 50, 1, "Expected Sprite Scheibe to have size 50 +-1");
  ...
  t.assert.withinRange(t.getSprite("Scheibe").x, 0, 5, "Expected Sprite Scheibe to have x-position 0 +-5");
  t.assert.withinRange(t.getSprite("Scheibe").y, 0, 5, "Expected Sprite Scheibe to have y-position 0 +-5");
  t.assert.withinRange(t.getSprite("Rot").x, 156, 5, "Expected Sprite Rot to have x-position 156 +-5");
  ...
  t.assert.equal(t.getSprite("Rot").getCloneCount(), 1, "Expected Sprite Rot to have 1 clones");
  t.assert.equal(t.getSprite("Scheibe").direction, 105, 1, "Expected Sprite Scheibe to face in direction 105 +-1");
  t.assert.equal(t.getSprite("Rot").direction, -50.36058343330296, 1, "Expected Sprite Rot to face in direction -50.36058343330296 +-1");
  t.assert.equal(t.getSprite("Rot").getClone(1).direction, -50.36058343330296, 1, "Expected Clone 1 of Rot to face in direction -50.36058343330296 +-1");
  t.assert.equal(t.getSprite("Scheibe").effects.color, 0, "Expected effect color of Sprite Scheibe to be 0");
  t.assert.equal(t.getSprite("Scheibe").effects.fisheye, 0, "Expected effect fisheye of Sprite Scheibe to be 0");
  t.assert.equal(t.getSprite("Scheibe").effects.whirl, 0, "Expected effect whirl of Sprite Scheibe to be 0");
  t.assert.equal(t.getSprite("Scheibe").effects.pixelate, 0, "Expected effect pixelate of Sprite Scheibe to be 0");
  ...
  t.assert.withinRange(t.getSprite("Rot").getClone(1).x, 136, 5, "Expected Clone 1 of Rot to have x-position 136 +-5");
  t.assert.withinRange(t.getSprite("Rot").getClone(1).y, -112.66666666666667, 5, "Expected Clone 1 of Rot to have y-position -112.66666666666667 +-5");
  t.assert.not(t.getSprite("Scheibe").sayText, "Expected Sprite Scheibe not to say anything");
  t.assert.not(t.getSprite("Rot").sayText, "Expected Sprite Rot not to say anything");
  t.assert.not(t.getSprite("Rot").getClone(1).sayText, "Expected Clone 1 of Rot not to say anything");
  t.assert.withinRange(t.getSprite("Scheibe").size, 50, 1, "Expected Sprite Scheibe to have size 50 +-1");
  ...
  t.assert.equal(t.getSprite("Rot").volume, 100, "Expected Sprite Rot to have volume 100");
  t.assert.equal(t.getSprite("Rot").getClone(1).volume, 100, "Expected Clone 1 of Rot to have volume 100");
  t.dragSprite('Rot', 12.38540492911562, 12.673397225908099, 1);
  await t.runForSteps(1);
  t.assert.equal(t.getStage().currentCostume, 0, "Expected backdrop 0");
  t.assert.equal(t.getSprite("Scheibe").currentCostume, 0, "Expected Sprite Scheibe to have costume 0");
  t.assert.equal(t.getSprite("Rot").currentCostume, 0, "Expected Sprite Rot to have costume 0");
  ...
  t.assert.equal(t.getSprite("Scheibe").volume, 100, "Expected Sprite Scheibe to have volume 100");
  t.assert.equal(t.getSprite("Rot").volume, 100, "Expected Sprite Rot to have volume 100");
  t.dragSprite('Rot', 16.108374712776257, -48.235860748211806, null);
  await t.runForSteps(1);
  t.assert.equal(t.getStage().currentCostume, 0, "Expected backdrop 0");
  t.assert.equal(t.getSprite("Scheibe").currentCostume, 0, "Expected Sprite Scheibe to have costume 0");
  t.assert.equal(t.getSprite("Rot").currentCostume, 0, "Expected Sprite Rot to have costume 0");
  ...
  t.assert.withinRange(t.getSprite("Scheibe").x, 0, 5, "Expected Sprite Scheibe to have x-position 0 +-5");
  t.assert.withinRange(t.getSprite("Scheibe").y, 0, 5, "Expected Sprite Scheibe to have y-position 0 +-5");
  t.assert.withinRange(t.getSprite("Rot").x, 16.108374712776257, 5, "Expected Sprite Rot to have x-position 16.108374712776257 +-5");
  t.assert.withinRange(t.getSprite("Rot").y, -48.235860748211806, 5, "Expected Sprite Rot to have y-position -48.235860748211806 +-5");
  t.assert.not(t.getSprite("Scheibe").sayText, "Expected Sprite Scheibe not to say anything");
  t.assert.not(t.getSprite("Rot").sayText, "Expected Sprite Rot not to say anything");
  t.assert.withinRange(t.getSprite("Scheibe").size, 50, 1, "Expected Sprite Scheibe to have size 50 +-1");
  t.assert.withinRange(t.getSprite("Rot").size, 80, 1, "Expected Sprite Rot to have size 80 +-1");
  ...
  t.assert.equal(t.getSprite("Rot").getCloneCount(), 1, "Expected Sprite Rot to have 1 clones");
  t.assert.equal(t.getSprite("Scheibe").direction, 105, 1, "Expected Sprite Scheibe to face in direction 105 +-1");
  t.assert.equal(t.getSprite("Rot").direction, 126.6637986084599, 1, "Expected Sprite Rot to face in direction 126.6637986084599 +-1");
  t.assert.equal(t.getSprite("Rot").getClone(1).direction, 126.6637986084599, 1, "Expected Clone 1 of Rot to face in direction 126.6637986084599 +-1");
  t.assert.equal(t.getSprite("Scheibe").effects.color, 0, "Expected effect color of Sprite Scheibe to be 0");
  t.assert.equal(t.getSprite("Scheibe").effects.fisheye, 0, "Expected effect fisheye of Sprite Scheibe to be 0");
  t.assert.equal(t.getSprite("Scheibe").effects.whirl, 0, "Expected effect whirl of Sprite Scheibe to be 0");
  t.assert.equal(t.getSprite("Scheibe").effects.pixelate, 0, "Expected effect pixelate of Sprite Scheibe to be 0");
  ...
  t.assert.withinRange(t.getSprite("Rot").getClone(1).x, -143.7111111111111, 5, "Expected Clone 1 of Rot to have x-position -143.7111111111111 +-5");
  t.assert.withinRange(t.getSprite("Rot").getClone(1).y, 106.97777777777777, 5, "Expected Clone 1 of Rot to have y-position 106.97777777777777 +-5");
  t.assert.not(t.getSprite("Scheibe").sayText, "Expected Sprite Scheibe not to say anything");
  t.assert.not(t.getSprite("Rot").sayText, "Expected Sprite Rot not to say anything");
  t.assert.not(t.getSprite("Rot").getClone(1).sayText, "Expected Clone 1 of Rot not to say anything");
  t.assert.withinRange(t.getSprite("Scheibe").size, 50, 1, "Expected Sprite Scheibe to have size 50 +-1");
  ...
  t.assert.withinRange(t.getSprite("Rot").x, -223, 5, "Expected Sprite Rot to have x-position -223 +-5");
  t.assert.withinRange(t.getSprite("Rot").y, 166, 5, "Expected Sprite Rot to have y-position 166 +-5");
  t.assert.withinRange(t.getSprite("Rot").getClone(1).x, -131.32222222222222, 5, "Expected Clone 1 of Rot to have x-position -131.32222222222222 +-5");
  t.assert.withinRange(t.getSprite("Rot").getClone(1).y, 97.75555555555556, 5, "Expected Clone 1 of Rot to have y-position 97.75555555555556 +-5");
  t.assert.not(t.getSprite("Scheibe").sayText, "Expected Sprite Scheibe not to say anything");
  t.assert.not(t.getSprite("Rot").sayText, "Expected Sprite Rot not to say anything");
  t.assert.not(t.getSprite("Rot").getClone(1).sayText, "Expected Clone 1 of Rot not to say anything");
  t.assert.withinRange(t.getSprite("Scheibe").size, 50, 1, "Expected Sprite Scheibe to have size 50 +-1");
  ...
  t.assert.withinRange(t.getSprite("Rot").x, -223, 5, "Expected Sprite Rot to have x-position -223 +-5");
  t.assert.withinRange(t.getSprite("Rot").y, 166, 5, "Expected Sprite Rot to have y-position 166 +-5");
  t.assert.withinRange(t.getSprite("Rot").getClone(1).x, -126.36666666666666, 5, "Expected Clone 1 of Rot to have x-position -126.36666666666666 +-5");
  t.assert.withinRange(t.getSprite("Rot").getClone(1).y, 94.06666666666666, 5, "Expected Clone 1 of Rot to have y-position 94.06666666666666 +-5");
  t.assert.not(t.getSprite("Scheibe").sayText, "Expected Sprite Scheibe not to say anything");
  t.assert.not(t.getSprite("Rot").sayText, "Expected Sprite Rot not to say anything");
  t.assert.not(t.getSprite("Rot").getClone(1).sayText, "Expected Clone 1 of Rot not to say anything");
  t.assert.withinRange(t.getSprite("Scheibe").size, 50, 1, "Expected Sprite Scheibe to have size 50 +-1");
  ...
  t.assert.withinRange(t.getSprite("Rot").getClone(1).y, 86.68888888888888, 5, "Expected Clone 1 of Rot to have y-position 86.68888888888888 +-5");
  t.assert.not(t.getSprite("Scheibe").sayText, "Expected Sprite Scheibe not to say anything");
  t.assert.not(t.getSprite("Rot").sayText, "Expected Sprite Rot not to say anything");
  t.assert.not(t.getSprite("Rot").getClone(1).sayText, "Expected Clone 1 of Rot not to say anything");
  t.assert.withinRange(t.getSprite("Scheibe").size, 50, 1, "Expected Sprite Scheibe to have size 50 +-1");
  ...
  t.assert.withinRange(t.getSprite("Rot").getClone(1).y, 83, 5, "Expected Clone 1 of Rot to have y-position 83 +-5");
  t.assert.not(t.getSprite("Scheibe").sayText, "Expected Sprite Scheibe not to say anything");
  t.assert.not(t.getSprite("Rot").sayText, "Expected Sprite Rot not to say anything");
  t.assert.not(t.getSprite("Rot").getClone(1).sayText, "Expected Clone 1 of Rot not to say anything");
  t.assert.withinRange(t.getSprite("Scheibe").size, 50, 1, "Expected Sprite Scheibe to have size 50 +-1");
  ...
  t.assert.withinRange(t.getSprite("Rot").getClone(1).y, 77.46666666666667, 5, "Expected Clone 1 of Rot to have y-position 77.46666666666667 +-5");
  t.assert.not(t.getSprite("Scheibe").sayText, "Expected Sprite Scheibe not to say anything");
  t.assert.not(t.getSprite("Rot").sayText, "Expected Sprite Rot not to say anything");
  t.assert.not(t.getSprite("Rot").getClone(1).sayText, "Expected Clone 1 of Rot not to say anything");
  t.assert.withinRange(t.getSprite("Scheibe").size, 50, 1, "Expected Sprite Scheibe to have size 50 +-1");
  ...
  t.assert.equal(t.getSprite("Rot").volume, 100, "Expected Sprite Rot to have volume 100");
  t.assert.equal(t.getSprite("Rot").getClone(1).volume, 100, "Expected Clone 1 of Rot to have volume 100");
  t.dragSprite('Rot', 13.871364369949934, -44.3051241487092, null);
  await t.runForSteps(1);
  t.assert.equal(t.getStage().currentCostume, 0, "Expected backdrop 0");
  t.assert.equal(t.getSprite("Scheibe").currentCostume, 0, "Expected Sprite Scheibe to have costume 0");
  t.assert.equal(t.getSprite("Rot").currentCostume, 0, "Expected Sprite Rot to have costume 0");
  ...
  t.assert.withinRange(t.getSprite("Scheibe").x, 0, 5, "Expected Sprite Scheibe to have x-position 0 +-5");
  t.assert.withinRange(t.getSprite("Scheibe").y, 0, 5, "Expected Sprite Scheibe to have y-position 0 +-5");
  t.assert.withinRange(t.getSprite("Rot").x, 13.871364369949934, 5, "Expected Sprite Rot to have x-position 13.871364369949934 +-5");
  t.assert.withinRange(t.getSprite("Rot").y, -44.3051241487092, 5, "Expected Sprite Rot to have y-position -44.3051241487092 +-5");
  t.assert.withinRange(t.getSprite("Rot").getClone(1).x, -101.5888888888889, 5, "Expected Clone 1 of Rot to have x-position -101.5888888888889 +-5");
  t.assert.withinRange(t.getSprite("Rot").getClone(1).y, 75.62222222222223, 5, "Expected Clone 1 of Rot to have y-position 75.62222222222223 +-5");
  t.assert.not(t.getSprite("Scheibe").sayText, "Expected Sprite Scheibe not to say anything");
  t.assert.not(t.getSprite("Rot").sayText, "Expected Sprite Rot not to say anything");
  t.assert.not(t.getSprite("Rot").getClone(1).sayText, "Expected Clone 1 of Rot not to say anything");
  t.assert.withinRange(t.getSprite("Scheibe").size, 50, 1, "Expected Sprite Scheibe to have size 50 +-1");
  ...
  t.assert.equal(t.getSprite("Rot").volume, 100, "Expected Sprite Rot to have volume 100");
  t.assert.equal(t.getSprite("Rot").getClone(1).volume, 100, "Expected Clone 1 of Rot to have volume 100");
  t.dragSprite('Rot', 17.68571766056303, -38.55816489999312, 1);
  await t.runForSteps(1);
  t.assert.equal(t.getStage().currentCostume, 0, "Expected backdrop 0");
  t.assert.equal(t.getSprite("Scheibe").currentCostume, 0, "Expected Sprite Scheibe to have costume 0");
  t.assert.equal(t.getSprite("Rot").currentCostume, 0, "Expected Sprite Rot to have costume 0");
  ...
  t.assert.equal(t.getSprite("Rot").getCloneCount(), 0, "Expected Sprite Rot to have 0 clones");
  t.assert.equal(t.getSprite("Scheibe").direction, 90, 1, "Expected Sprite Scheibe to face in direction 90 +-1");
  t.assert.equal(t.getSprite("Rot").direction, -128.76044476566932, 1, "Expected Sprite Rot to face in direction -128.76044476566932 +-1");
  t.assert.equal(t.getSprite("Scheibe").effects.color, 0, "Expected effect color of Sprite Scheibe to be 0");
  t.assert.equal(t.getSprite("Scheibe").effects.fisheye, 0, "Expected effect fisheye of Sprite Scheibe to be 0");
  t.assert.equal(t.getSprite("Scheibe").effects.whirl, 0, "Expected effect whirl of Sprite Scheibe to be 0");
  t.assert.equal(t.getSprite("Scheibe").effects.pixelate, 0, "Expected effect pixelate of Sprite Scheibe to be 0");
  ...
  t.assert.withinRange(t.getSprite("Rot").y, -43, 5, "Expected Sprite Rot to have y-position -43 +-5");
  t.assert.not(t.getSprite("Scheibe").sayText, "Expected Sprite Scheibe not to say anything");
  t.assert.not(t.getSprite("Rot").sayText, "Expected Sprite Rot not to say anything");
  t.assert.withinRange(t.getSprite("Scheibe").size, 50, 1, "Expected Sprite Scheibe to have size 50 +-1");
  t.assert.withinRange(t.getSprite("Rot").size, 80, 1, "Expected Sprite Rot to have size 80 +-1");
  ...
  t.assert.withinRange(t.getSprite("Scheibe").x, 0, 5, "Expected Sprite Scheibe to have x-position 0 +-5");
  t.assert.withinRange(t.getSprite("Scheibe").y, 0, 5, "Expected Sprite Scheibe to have y-position 0 +-5");
  t.assert.withinRange(t.getSprite("Rot").x, 140, 5, "Expected Sprite Rot to have x-position 140 +-5");
  t.assert.withinRange(t.getSprite("Rot").y, 178, 5, "Expected Sprite Rot to have y-position 178 +-5");
  t.assert.not(t.getSprite("Scheibe").sayText, "Expected Sprite Scheibe not to say anything");
  t.assert.not(t.getSprite("Rot").sayText, "Expected Sprite Rot not to say anything");
  t.assert.withinRange(t.getSprite("Scheibe").size, 50, 1, "Expected Sprite Scheibe to have size 50 +-1");
  ...
  t.assert.equal(t.getSprite("Rot").getCloneCount(), 1, "Expected Sprite Rot to have 1 clones");
  t.assert.equal(t.getSprite("Scheibe").direction, 81, 1, "Expected Sprite Scheibe to face in direction 81 +-1");
  t.assert.equal(t.getSprite("Rot").direction, 117.79804811385607, 1, "Expected Sprite Rot to face in direction 117.79804811385607 +-1");
  t.assert.equal(t.getSprite("Rot").getClone(1).direction, 117.79804811385607, 1, "Expected Clone 1 of Rot to face in direction 117.79804811385607 +-1");
  t.assert.equal(t.getSprite("Scheibe").effects.color, 0, "Expected effect color of Sprite Scheibe to be 0");
  t.assert.equal(t.getSprite("Scheibe").effects.fisheye, 0, "Expected effect fisheye of Sprite Scheibe to be 0");
  t.assert.equal(t.getSprite("Scheibe").effects.whirl, 0, "Expected effect whirl of Sprite Scheibe to be 0");
  t.assert.equal(t.getSprite("Scheibe").effects.pixelate, 0, "Expected effect pixelate of Sprite Scheibe to be 0");
  ...
  t.assert.withinRange(t.getSprite("Rot").getClone(1).y, 53.2, 5, "Expected Clone 1 of Rot to have y-position 53.2 +-5");
  t.assert.not(t.getSprite("Scheibe").sayText, "Expected Sprite Scheibe not to say anything");
  t.assert.not(t.getSprite("Rot").sayText, "Expected Sprite Rot not to say anything");
  t.assert.not(t.getSprite("Rot").getClone(1).sayText, "Expected Clone 1 of Rot not to say anything");
  t.assert.withinRange(t.getSprite("Scheibe").size, 50, 1, "Expected Sprite Scheibe to have size 50 +-1");
  ...
  t.assert.withinRange(t.getSprite("Rot").x, -239, 5, "Expected Sprite Rot to have x-position -239 +-5");
  t.assert.withinRange(t.getSprite("Rot").y, 126, 5, "Expected Sprite Rot to have y-position 126 +-5");
  t.assert.withinRange(t.getSprite("Rot").getClone(1).x, -90.28888888888889, 5, "Expected Clone 1 of Rot to have x-position -90.28888888888889 +-5");
  t.assert.withinRange(t.getSprite("Rot").getClone(1).y, 47.599999999999994, 5, "Expected Clone 1 of Rot to have y-position 47.599999999999994 +-5");
  t.assert.not(t.getSprite("Scheibe").sayText, "Expected Sprite Scheibe not to say anything");
  t.assert.not(t.getSprite("Rot").sayText, "Expected Sprite Rot not to say anything");
  t.assert.not(t.getSprite("Rot").getClone(1).sayText, "Expected Clone 1 of Rot not to say anything");
  t.assert.withinRange(t.getSprite("Scheibe").size, 50, 1, "Expected Sprite Scheibe to have size 50 +-1");
  ...
  t.assert.equal(t.getSprite("Rot").volume, 100, "Expected Sprite Rot to have volume 100");
  t.assert.equal(t.getSprite("Rot").getClone(1).volume, 100, "Expected Clone 1 of Rot to have volume 100");
  t.dragSprite('Rot', 52.386157176473716, -48.588718074369325, null);
  await t.runForSteps(1);
  t.assert.equal(t.getStage().currentCostume, 0, "Expected backdrop 0");
  t.assert.equal(t.getSprite("Scheibe").currentCostume, 0, "Expected Sprite Scheibe to have costume 0");
  t.assert.equal(t.getSprite("Rot").currentCostume, 0, "Expected Sprite Rot to have costume 0");
  ...
  t.assert.withinRange(t.getSprite("Scheibe").x, 0, 5, "Expected Sprite Scheibe to have x-position 0 +-5");
  t.assert.withinRange(t.getSprite("Scheibe").y, 0, 5, "Expected Sprite Scheibe to have y-position 0 +-5");
  t.assert.withinRange(t.getSprite("Rot").x, 52.386157176473716, 5, "Expected Sprite Rot to have x-position 52.386157176473716 +-5");
  t.assert.withinRange(t.getSprite("Rot").y, -48.588718074369325, 5, "Expected Sprite Rot to have y-position -48.588718074369325 +-5");
  t.assert.withinRange(t.getSprite("Rot").getClone(1).x, -87.63333333333335, 5, "Expected Clone 1 of Rot to have x-position -87.63333333333335 +-5");
  t.assert.withinRange(t.getSprite("Rot").getClone(1).y, 46.2, 5, "Expected Clone 1 of Rot to have y-position 46.2 +-5");
  t.assert.not(t.getSprite("Scheibe").sayText, "Expected Sprite Scheibe not to say anything");
  t.assert.not(t.getSprite("Rot").sayText, "Expected Sprite Rot not to say anything");
  t.assert.not(t.getSprite("Rot").getClone(1).sayText, "Expected Clone 1 of Rot not to say anything");
  t.assert.withinRange(t.getSprite("Scheibe").size, 50, 1, "Expected Sprite Scheibe to have size 50 +-1");
  ...
  t.assert.equal(t.getSprite("Rot").getCloneCount(), 0, "Expected Sprite Rot to have 0 clones");
  t.assert.equal(t.getSprite("Scheibe").direction, 90, 1, "Expected Sprite Scheibe to face in direction 90 +-1");
  t.assert.equal(t.getSprite("Rot").direction, 55.368017093128906, 1, "Expected Sprite Rot to face in direction 55.368017093128906 +-1");
  t.assert.equal(t.getSprite("Scheibe").effects.color, 0, "Expected effect color of Sprite Scheibe to be 0");
  t.assert.equal(t.getSprite("Scheibe").effects.fisheye, 0, "Expected effect fisheye of Sprite Scheibe to be 0");
  t.assert.equal(t.getSprite("Scheibe").effects.whirl, 0, "Expected effect whirl of Sprite Scheibe to be 0");
  t.assert.equal(t.getSprite("Scheibe").effects.pixelate, 0, "Expected effect pixelate of Sprite Scheibe to be 0");
  ...
  t.assert.withinRange(t.getSprite("Scheibe").x, 0, 5, "Expected Sprite Scheibe to have x-position 0 +-5");
  t.assert.withinRange(t.getSprite("Scheibe").y, 0, 5, "Expected Sprite Scheibe to have y-position 0 +-5");
  t.assert.withinRange(t.getSprite("Rot").x, -67, 5, "Expected Sprite Rot to have x-position -67 +-5");
  t.assert.withinRange(t.getSprite("Rot").y, -115, 5, "Expected Sprite Rot to have y-position -115 +-5");
  t.assert.not(t.getSprite("Scheibe").sayText, "Expected Sprite Scheibe not to say anything");
  t.assert.not(t.getSprite("Rot").sayText, "Expected Sprite Rot not to say anything");
  t.assert.withinRange(t.getSprite("Scheibe").size, 50, 1, "Expected Sprite Scheibe to have size 50 +-1");
  t.assert.withinRange(t.getSprite("Rot").size, 80, 1, "Expected Sprite Rot to have size 80 +-1");
