const test0 = async function (t) {
  ...
  t.assert.withinRange(t.getSprite("Hindernis").getClone(1).x, 107, 5, "Expected Clone 1 of Hindernis to have x-position 107 +-5");
  ...
  t.dragSprite('Skikatze', 176.11591983674873, 45.93208789485408, null);
  await t.runForSteps(1);
  t.assert.equal(t.getStage().currentCostume, 0, "Expected backdrop 0");
  t.assert.equal(t.getSprite("Skikatze").currentCostume, 0, "Expected Sprite Skikatze to have costume 0");
  t.assert.equal(t.getSprite("Hindernis").currentCostume, 0, "Expected Sprite Hindernis to have costume 0");
  ...
  t.assert.equal(t.getSprite("Hindernis").layerOrder, 2, "Expected Sprite Hindernis to be at layer 2");
  t.assert.equal(t.getSprite("Hindernis").getClone(1).getLayerOrder(), 1, "Expected Clone 1 of Hindernis to be at layer 1");
  t.assert.withinRange(t.getSprite("Skikatze").x, 178.11591983674873, 5, "Expected Sprite Skikatze to have x-position 178.11591983674873 +-5");
  t.assert.withinRange(t.getSprite("Skikatze").y, 45.93208789485408, 5, "Expected Sprite Skikatze to have y-position 45.93208789485408 +-5");
  t.assert.withinRange(t.getSprite("Hindernis").x, -70, 5, "Expected Sprite Hindernis to have x-position -70 +-5");
  t.assert.withinRange(t.getSprite("Hindernis").y, -32.04599999999999, 5, "Expected Sprite Hindernis to have y-position -32.04599999999999 +-5");
  t.assert.withinRange(t.getSprite("Hindernis").getClone(1).x, 107, 5, "Expected Clone 1 of Hindernis to have x-position 107 +-5");
  ...
  t.assert.withinRange(t.getSprite("Hindernis").getClone(2).x, -14, 5, "Expected Clone 2 of Hindernis to have x-position -14 +-5");
...
const test1 = async function (t) {
  ...
  t.assert.equal(t.getSprite("Hindernis").getClone(1).getLayerOrder(), 1, "Expected Clone 1 of Hindernis to be at layer 1");
  t.assert.equal(t.getSprite("Hindernis").getClone(2).getLayerOrder(), 2, "Expected Clone 2 of Hindernis to be at layer 2");
  t.assert.withinRange(t.getSprite("Skikatze").x, 66, 5, "Expected Sprite Skikatze to have x-position 66 +-5");
  t.assert.withinRange(t.getSprite("Skikatze").y, 100, 5, "Expected Sprite Skikatze to have y-position 100 +-5");
  t.assert.withinRange(t.getSprite("Hindernis").x, -70, 5, "Expected Sprite Hindernis to have x-position -70 +-5");
  t.assert.withinRange(t.getSprite("Hindernis").y, -32.04599999999999, 5, "Expected Sprite Hindernis to have y-position -32.04599999999999 +-5");
  t.assert.withinRange(t.getSprite("Hindernis").getClone(1).x, 107, 5, "Expected Clone 1 of Hindernis to have x-position 107 +-5");
  ...
  t.assert.withinRange(t.getSprite("Hindernis").getClone(2).x, -14, 5, "Expected Clone 2 of Hindernis to have x-position -14 +-5");
  t.assert.withinRange(t.getSprite("Hindernis").getClone(2).y, -168.1, 5, "Expected Clone 2 of Hindernis to have y-position -168.1 +-5");
  t.assert.not(t.getSprite("Skikatze").sayText, "Expected Sprite Skikatze not to say anything");
  t.assert.not(t.getSprite("Hindernis").sayText, "Expected Sprite Hindernis not to say anything");
  t.assert.not(t.getSprite("Hindernis").getClone(1).sayText, "Expected Clone 1 of Hindernis not to say anything");
  t.assert.not(t.getSprite("Hindernis").getClone(2).sayText, "Expected Clone 2 of Hindernis not to say anything");
  ...
  t.assert.withinRange(t.getSprite("Hindernis").y, -32.04599999999999, 5, "Expected Sprite Hindernis to have y-position -32.04599999999999 +-5");
  t.assert.withinRange(t.getSprite("Hindernis").getClone(1).x, 107, 5, "Expected Clone 1 of Hindernis to have x-position 107 +-5");
  t.assert.withinRange(t.getSprite("Hindernis").getClone(1).y, 30, 5, "Expected Clone 1 of Hindernis to have y-position 30 +-5");
  t.assert.withinRange(t.getSprite("Hindernis").getClone(2).x, -14, 5, "Expected Clone 2 of Hindernis to have x-position -14 +-5");
  t.assert.withinRange(t.getSprite("Hindernis").getClone(2).y, -150.4, 5, "Expected Clone 2 of Hindernis to have y-position -150.4 +-5");
  t.assert.not(t.getSprite("Skikatze").sayText, "Expected Sprite Skikatze not to say anything");
  t.assert.not(t.getSprite("Hindernis").sayText, "Expected Sprite Hindernis not to say anything");
  t.assert.not(t.getSprite("Hindernis").getClone(1).sayText, "Expected Clone 1 of Hindernis not to say anything");
  t.assert.not(t.getSprite("Hindernis").getClone(2).sayText, "Expected Clone 2 of Hindernis not to say anything");
...
const test2 = async function (t) {
  ...
  t.assert.equal(t.getSprite("Skikatze").layerOrder, 2, "Expected Sprite Skikatze to be at layer 2");
  t.assert.equal(t.getSprite("Hindernis").layerOrder, 1, "Expected Sprite Hindernis to be at layer 1");
  t.assert.withinRange(t.getSprite("Skikatze").x, 76, 5, "Expected Sprite Skikatze to have x-position 76 +-5");
  t.assert.withinRange(t.getSprite("Skikatze").y, 100, 5, "Expected Sprite Skikatze to have y-position 100 +-5");
  t.assert.withinRange(t.getSprite("Hindernis").x, -70, 5, "Expected Sprite Hindernis to have x-position -70 +-5");
  t.assert.withinRange(t.getSprite("Hindernis").y, -32.04599999999999, 5, "Expected Sprite Hindernis to have y-position -32.04599999999999 +-5");
  t.assert.not(t.getSprite("Skikatze").sayText, "Expected Sprite Skikatze not to say anything");
