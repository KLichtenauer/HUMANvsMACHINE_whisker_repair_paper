const test0 = async function (t) {
  t.dragSprite('Spieler', 204.41136322184826, -136.83272029634682, null);
  ...
  t.assert.withinRange(t.getSprite("Münzen").x, 0, 5, "Expected Sprite Münzen to have x-position 0 +-5");
  ...
  t.assert.equal(t.getSprite("Münzen").volume, 100, "Expected Sprite Münzen to have volume 100");
  t.assert.equal(t.getSprite("Eis").volume, 100, "Expected Sprite Eis to have volume 100");
  t.dragSprite('Münzen', 170.67185308949055, -180, null);
  await t.runForSteps(1);
  t.assert.equal(t.getStage().currentCostume, 0, "Expected backdrop 0");
  t.assert.equal(t.getSprite("Spieler").currentCostume, 0, "Expected Sprite Spieler to have costume 0");
  t.assert.equal(t.getSprite("Freundin").currentCostume, 0, "Expected Sprite Freundin to have costume 0");
  ...
  t.assert.withinRange(t.getSprite("Freundin").x, 60, 5, "Expected Sprite Freundin to have x-position 60 +-5");
  t.assert.withinRange(t.getSprite("Freundin").y, -131, 5, "Expected Sprite Freundin to have y-position -131 +-5");
  t.assert.withinRange(t.getSprite("Münzen").x, 170.67185308949055, 5, "Expected Sprite Münzen to have x-position 170.67185308949055 +-5");
  ...
  t.assert.equal(t.getSprite("Münzen").volume, 100, "Expected Sprite Münzen to have volume 100");
  t.assert.equal(t.getSprite("Eis").volume, 100, "Expected Sprite Eis to have volume 100");
  t.dragSprite('Spieler', -128.47171563216307, -50.28290235568211, null);
  await t.runForSteps(1);
  t.assert.equal(t.getStage().currentCostume, 0, "Expected backdrop 0");
  t.assert.equal(t.getSprite("Spieler").currentCostume, 0, "Expected Sprite Spieler to have costume 0");
  t.assert.equal(t.getSprite("Freundin").currentCostume, 0, "Expected Sprite Freundin to have costume 0");
  ...
  t.assert.equal(t.getSprite("Münzen").layerOrder, 4, "Expected Sprite Münzen to be at layer 4");
  t.assert.equal(t.getSprite("Eis").layerOrder, 2, "Expected Sprite Eis to be at layer 2");
  t.assert.withinRange(t.getSprite("Spieler").x, -128.47171563216307, 5, "Expected Sprite Spieler to have x-position -128.47171563216307 +-5");
  t.assert.withinRange(t.getSprite("Spieler").y, -50.28290235568211, 5, "Expected Sprite Spieler to have y-position -50.28290235568211 +-5");
  t.assert.withinRange(t.getSprite("Freundin").x, 60, 5, "Expected Sprite Freundin to have x-position 60 +-5");
  t.assert.withinRange(t.getSprite("Freundin").y, -131, 5, "Expected Sprite Freundin to have y-position -131 +-5");
  t.assert.withinRange(t.getSprite("Münzen").x, 170.67185308949055, 5, "Expected Sprite Münzen to have x-position 170.67185308949055 +-5");
  t.assert.withinRange(t.getSprite("Münzen").y, -180, 5, "Expected Sprite Münzen to have y-position -180 +-5");
  ...
  t.assert.equal(t.getSprite("Münzen").layerOrder, 4, "Expected Sprite Münzen to be at layer 4");
  t.assert.equal(t.getSprite("Eis").layerOrder, 2, "Expected Sprite Eis to be at layer 2");
  t.assert.withinRange(t.getSprite("Spieler").x, -198.47171563216307, 5, "Expected Sprite Spieler to have x-position -198.47171563216307 +-5");
  t.assert.withinRange(t.getSprite("Spieler").y, 99.7170976443179, 5, "Expected Sprite Spieler to have y-position 99.7170976443179 +-5");
  t.assert.withinRange(t.getSprite("Freundin").x, 60, 5, "Expected Sprite Freundin to have x-position 60 +-5");
  t.assert.withinRange(t.getSprite("Freundin").y, -131, 5, "Expected Sprite Freundin to have y-position -131 +-5");
  t.assert.withinRange(t.getSprite("Münzen").x, 170.67185308949055, 5, "Expected Sprite Münzen to have x-position 170.67185308949055 +-5");
  t.assert.withinRange(t.getSprite("Münzen").y, -180, 5, "Expected Sprite Münzen to have y-position -180 +-5");
...
const test1 = async function (t) {
  ...
  t.assert.equal(t.getSprite("Münzen").layerOrder, 4, "Expected Sprite Münzen to be at layer 4");
  t.assert.equal(t.getSprite("Eis").layerOrder, 2, "Expected Sprite Eis to be at layer 2");
  t.assert.withinRange(t.getSprite("Spieler").x, -198, 5, "Expected Sprite Spieler to have x-position -198 +-5");
  ...
  t.assert.equal(t.getSprite("Münzen").volume, 100, "Expected Sprite Münzen to have volume 100");
  t.assert.equal(t.getSprite("Eis").volume, 100, "Expected Sprite Eis to have volume 100");
  t.dragSprite('Münzen', -92.29770949923218, -22.682727394248452, null);
  await t.runForSteps(1);
  t.assert.equal(t.getStage().currentCostume, 0, "Expected backdrop 0");
  t.assert.equal(t.getSprite("Spieler").currentCostume, 0, "Expected Sprite Spieler to have costume 0");
  t.assert.equal(t.getSprite("Freundin").currentCostume, 0, "Expected Sprite Freundin to have costume 0");
  ...
  t.assert.equal(t.getSprite("Münzen").layerOrder, 4, "Expected Sprite Münzen to be at layer 4");
  t.assert.equal(t.getSprite("Eis").layerOrder, 2, "Expected Sprite Eis to be at layer 2");
  t.assert.withinRange(t.getSprite("Spieler").x, -193, 5, "Expected Sprite Spieler to have x-position -193 +-5");
  t.assert.withinRange(t.getSprite("Spieler").y, -80, 5, "Expected Sprite Spieler to have y-position -80 +-5");
  t.assert.withinRange(t.getSprite("Freundin").x, 60, 5, "Expected Sprite Freundin to have x-position 60 +-5");
  t.assert.withinRange(t.getSprite("Freundin").y, -131, 5, "Expected Sprite Freundin to have y-position -131 +-5");
  t.assert.withinRange(t.getSprite("Münzen").x, -92.29770949923218, 5, "Expected Sprite Münzen to have x-position -92.29770949923218 +-5");
  t.assert.withinRange(t.getSprite("Münzen").y, -22.682727394248452, 5, "Expected Sprite Münzen to have y-position -22.682727394248452 +-5");
  t.assert.withinRange(t.getSprite("Eis").x, 195, 5, "Expected Sprite Eis to have x-position 195 +-5");
  t.assert.withinRange(t.getSprite("Eis").y, -158, 5, "Expected Sprite Eis to have y-position -158 +-5");
  t.assert.not(t.getSprite("Spieler").sayText, "Expected Sprite Spieler not to say anything");
  t.assert.not(t.getSprite("Freundin").sayText, "Expected Sprite Freundin not to say anything");
