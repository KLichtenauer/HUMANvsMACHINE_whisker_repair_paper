const test0 = async function (t) {
  ...
  t.assert.withinRange(t.getSprite("Skikatze").x, 88, 5, "Expected Sprite Skikatze to have x-position 88 +-5");
  t.assert.withinRange(t.getSprite("Skikatze").y, 100, 5, "Expected Sprite Skikatze to have y-position 100 +-5");
  t.assert.withinRange(t.getSprite("Hindernis").getClone(1).x, 19, 5, "Expected Clone 1 of Hindernis to have x-position 19 +-5");
  t.assert.withinRange(t.getSprite("Hindernis").getClone(1).y, 78, 5, "Expected Clone 1 of Hindernis to have y-position 78 +-5");
  t.assert.withinRange(t.getSprite("Hindernis").getClone(2).x, 192, 5, "Expected Clone 2 of Hindernis to have x-position 192 +-5");
  t.assert.withinRange(t.getSprite("Hindernis").getClone(2).y, -103.2, 5, "Expected Clone 2 of Hindernis to have y-position -103.2 +-5");
