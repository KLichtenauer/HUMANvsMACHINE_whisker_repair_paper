const test0 = async function (t) {
  ...
  t.assert.withinRange(t.getSprite("Kreatur").getClone(1).x, -98, 5, "Expected Clone 1 of Kreatur to have x-position -98 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(1).y, 19, 5, "Expected Clone 1 of Kreatur to have y-position 19 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(2).x, -155, 5, "Expected Clone 2 of Kreatur to have x-position -155 +-5");
  ...
  t.assert.withinRange(t.getSprite("Kreatur").getClone(3).y, -128, 5, "Expected Clone 3 of Kreatur to have y-position -128 +-5");
  ...
  t.assert.withinRange(t.getSprite("Kreatur").getClone(1).size, 62, 1, "Expected Clone 1 of Kreatur to have size 62 +-1");
...
const test1 = async function (t) {
  ...
  t.assert.withinRange(t.getSprite("Gobo").size, 60, 1, "Expected Sprite Gobo to have size 60 +-1");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(1).size, 62, 1, "Expected Clone 1 of Kreatur to have size 62 +-1");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(2).size, 73, 1, "Expected Clone 2 of Kreatur to have size 73 +-1");
  ...
  t.assert.withinRange(t.getSprite("Gobo").x, -110, 5, "Expected Sprite Gobo to have x-position -110 +-5");
  t.assert.withinRange(t.getSprite("Gobo").y, 110, 5, "Expected Sprite Gobo to have y-position 110 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(1).x, -30, 5, "Expected Clone 1 of Kreatur to have x-position -30 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(1).y, 108, 5, "Expected Clone 1 of Kreatur to have y-position 108 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(2).x, -106, 5, "Expected Clone 2 of Kreatur to have x-position -106 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(2).y, -24, 5, "Expected Clone 2 of Kreatur to have y-position -24 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(3).x, 59, 5, "Expected Clone 3 of Kreatur to have x-position 59 +-5");
  ...
  t.assert.withinRange(t.getSprite("Kreatur").size, 499, 1, "Expected Sprite Kreatur to have size 499 +-1");
  t.assert.withinRange(t.getSprite("Gobo").size, 60, 1, "Expected Sprite Gobo to have size 60 +-1");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(1).size, 93, 1, "Expected Clone 1 of Kreatur to have size 93 +-1");
  ...
  t.assert.withinRange(t.getSprite("Gobo").x, -110, 5, "Expected Sprite Gobo to have x-position -110 +-5");
  t.assert.withinRange(t.getSprite("Gobo").y, 110, 5, "Expected Sprite Gobo to have y-position 110 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(1).x, 48, 5, "Expected Clone 1 of Kreatur to have x-position 48 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(1).y, -73, 5, "Expected Clone 1 of Kreatur to have y-position -73 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(2).x, -230, 5, "Expected Clone 2 of Kreatur to have x-position -230 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(2).y, -109, 5, "Expected Clone 2 of Kreatur to have y-position -109 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(3).x, 217, 5, "Expected Clone 3 of Kreatur to have x-position 217 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(3).y, -103, 5, "Expected Clone 3 of Kreatur to have y-position -103 +-5");
  t.assert.not(t.getSprite("Kreatur").sayText, "Expected Sprite Kreatur not to say anything");
  t.assert.not(t.getSprite("Gobo").sayText, "Expected Sprite Gobo not to say anything");
  t.assert.not(t.getSprite("Kreatur").getClone(1).sayText, "Expected Clone 1 of Kreatur not to say anything");
  t.assert.not(t.getSprite("Kreatur").getClone(2).sayText, "Expected Clone 2 of Kreatur not to say anything");
  ...
  t.assert.withinRange(t.getSprite("Kreatur").size, 499, 1, "Expected Sprite Kreatur to have size 499 +-1");
  t.assert.withinRange(t.getSprite("Gobo").size, 60, 1, "Expected Sprite Gobo to have size 60 +-1");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(1).size, 78, 1, "Expected Clone 1 of Kreatur to have size 78 +-1");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(2).size, 52, 1, "Expected Clone 2 of Kreatur to have size 52 +-1");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(3).size, 59, 1, "Expected Clone 3 of Kreatur to have size 59 +-1");
  t.assert.not(t.getSprite("Kreatur").visible, "Expected Sprite Kreatur not to be visible");
  t.assert.not(t.getSprite("Gobo").visible, "Expected Sprite Gobo not to be visible");
  t.assert.ok(t.getSprite("Kreatur").getClone(1).visible, "Expected Clone 1 of Kreatur to be visible");
  t.assert.ok(t.getSprite("Kreatur").getClone(2).visible, "Expected Clone 2 of Kreatur to be visible");
...
const test2 = async function (t) {
  ...
  t.assert.withinRange(t.getSprite("Kreatur").getClone(1).x, -30, 5, "Expected Clone 1 of Kreatur to have x-position -30 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(1).y, 108, 5, "Expected Clone 1 of Kreatur to have y-position 108 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(2).x, -82, 5, "Expected Clone 2 of Kreatur to have x-position -82 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(2).y, -161, 5, "Expected Clone 2 of Kreatur to have y-position -161 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(3).x, 59, 5, "Expected Clone 3 of Kreatur to have x-position 59 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(3).y, 57, 5, "Expected Clone 3 of Kreatur to have y-position 57 +-5");
  t.assert.not(t.getSprite("Kreatur").sayText, "Expected Sprite Kreatur not to say anything");
  t.assert.not(t.getSprite("Gobo").sayText, "Expected Sprite Gobo not to say anything");
  ...
  t.assert.withinRange(t.getSprite("Gobo").x, -110, 5, "Expected Sprite Gobo to have x-position -110 +-5");
  t.assert.withinRange(t.getSprite("Gobo").y, 110, 5, "Expected Sprite Gobo to have y-position 110 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(1).x, -162, 5, "Expected Clone 1 of Kreatur to have x-position -162 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(1).y, -161, 5, "Expected Clone 1 of Kreatur to have y-position -161 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(2).x, 53, 5, "Expected Clone 2 of Kreatur to have x-position 53 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(2).y, -26, 5, "Expected Clone 2 of Kreatur to have y-position -26 +-5");
  ...
  t.assert.withinRange(t.getSprite("Kreatur").getClone(2).size, 94, 1, "Expected Clone 2 of Kreatur to have size 94 +-1");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(3).size, 82, 1, "Expected Clone 3 of Kreatur to have size 82 +-1");
  t.assert.not(t.getSprite("Kreatur").visible, "Expected Sprite Kreatur not to be visible");
  t.assert.not(t.getSprite("Gobo").visible, "Expected Sprite Gobo not to be visible");
  t.assert.ok(t.getSprite("Kreatur").getClone(1).visible, "Expected Clone 1 of Kreatur to be visible");
  t.assert.ok(t.getSprite("Kreatur").getClone(2).visible, "Expected Clone 2 of Kreatur to be visible");
