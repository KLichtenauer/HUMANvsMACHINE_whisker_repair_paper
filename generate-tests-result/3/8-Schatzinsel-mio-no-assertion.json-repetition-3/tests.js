const test0 = async function (t) {
  ...
  t.assert.withinRange(t.getSprite("Pirat").x, -31.666666666666657, 5, "Expected Sprite Pirat to have x-position -31.666666666666657 +-5");
  t.assert.withinRange(t.getSprite("Pirat").y, -68.86666666666666, 5, "Expected Sprite Pirat to have y-position -68.86666666666666 +-5");
  ...
  t.assert.equal(t.getSprite("Schatztruhe").layerOrder, 2, "Expected Sprite Schatztruhe to be at layer 2");
  t.assert.equal(t.getSprite("Mädchen").layerOrder, 5, "Expected Sprite Mädchen to be at layer 5");
  t.assert.withinRange(t.getSprite("Pirat").x, 16.94444444444443, 5, "Expected Sprite Pirat to have x-position 16.94444444444443 +-5");
  t.assert.withinRange(t.getSprite("Pirat").y, -69.25555555555556, 5, "Expected Sprite Pirat to have y-position -69.25555555555556 +-5");
  t.assert.withinRange(t.getSprite("Schatzkarte").x, 0, 5, "Expected Sprite Schatzkarte to have x-position 0 +-5");
  t.assert.withinRange(t.getSprite("Schatzkarte").y, -20, 5, "Expected Sprite Schatzkarte to have y-position -20 +-5");
  t.assert.withinRange(t.getSprite("Vulkaninsel").x, -58, 5, "Expected Sprite Vulkaninsel to have x-position -58 +-5");
  t.assert.withinRange(t.getSprite("Vulkaninsel").y, 10, 5, "Expected Sprite Vulkaninsel to have y-position 10 +-5");
  ...
  t.assert.equal(t.getSprite("Schatztruhe").layerOrder, 2, "Expected Sprite Schatztruhe to be at layer 2");
  t.assert.equal(t.getSprite("Mädchen").layerOrder, 5, "Expected Sprite Mädchen to be at layer 5");
  t.assert.withinRange(t.getSprite("Pirat").x, 56.666666666666664, 5, "Expected Sprite Pirat to have x-position 56.666666666666664 +-5");
  t.assert.withinRange(t.getSprite("Pirat").y, 15.833333333333332, 5, "Expected Sprite Pirat to have y-position 15.833333333333332 +-5");
  t.assert.withinRange(t.getSprite("Schatzkarte").x, 0, 5, "Expected Sprite Schatzkarte to have x-position 0 +-5");
  t.assert.withinRange(t.getSprite("Schatzkarte").y, -20, 5, "Expected Sprite Schatzkarte to have y-position -20 +-5");
  t.assert.withinRange(t.getSprite("Vulkaninsel").x, -58, 5, "Expected Sprite Vulkaninsel to have x-position -58 +-5");
  t.assert.withinRange(t.getSprite("Vulkaninsel").y, 10, 5, "Expected Sprite Vulkaninsel to have y-position 10 +-5");
  ...
  t.assert.equal(t.getSprite("Schatztruhe").layerOrder, 2, "Expected Sprite Schatztruhe to be at layer 2");
  t.assert.equal(t.getSprite("Mädchen").layerOrder, 5, "Expected Sprite Mädchen to be at layer 5");
  t.assert.withinRange(t.getSprite("Pirat").x, 12.666666666666671, 5, "Expected Sprite Pirat to have x-position 12.666666666666671 +-5");
  t.assert.withinRange(t.getSprite("Pirat").y, 10.333333333333334, 5, "Expected Sprite Pirat to have y-position 10.333333333333334 +-5");
  t.assert.withinRange(t.getSprite("Schatzkarte").x, 0, 5, "Expected Sprite Schatzkarte to have x-position 0 +-5");
  t.assert.withinRange(t.getSprite("Schatzkarte").y, -20, 5, "Expected Sprite Schatzkarte to have y-position -20 +-5");
  t.assert.withinRange(t.getSprite("Vulkaninsel").x, -58, 5, "Expected Sprite Vulkaninsel to have x-position -58 +-5");
  t.assert.withinRange(t.getSprite("Vulkaninsel").y, 10, 5, "Expected Sprite Vulkaninsel to have y-position 10 +-5");
  ...
  t.assert.equal(t.getSprite("Schatztruhe").layerOrder, 2, "Expected Sprite Schatztruhe to be at layer 2");
  t.assert.equal(t.getSprite("Mädchen").layerOrder, 5, "Expected Sprite Mädchen to be at layer 5");
  t.assert.withinRange(t.getSprite("Pirat").x, -5, 5, "Expected Sprite Pirat to have x-position -5 +-5");
