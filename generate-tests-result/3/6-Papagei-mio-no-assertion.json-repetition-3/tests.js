const test0 = async function (t) {
  ...
  t.assert.withinRange(t.getSprite("Milch").x, -5, 5, "Expected Sprite Milch to have x-position -5 +-5");
  t.assert.withinRange(t.getSprite("Milch").y, 1, 5, "Expected Sprite Milch to have y-position 1 +-5");
  ...
  t.assert.equal(t.getSprite("Baum").layerOrder, 2, "Expected Sprite Baum to be at layer 2");
  t.assert.equal(t.getSprite("Milch").layerOrder, 3, "Expected Sprite Milch to be at layer 3");
  t.assert.withinRange(t.getSprite("Papagei").x, -53.748159108202444, 5, "Expected Sprite Papagei to have x-position -53.748159108202444 +-5");
  t.assert.withinRange(t.getSprite("Papagei").y, -11.529905038722735, 5, "Expected Sprite Papagei to have y-position -11.529905038722735 +-5");
