const test0 = async function (t) {
  ...
  t.assert.withinRange(t.getSprite("Kreatur").getClone(1).x, 63, 5, "Expected Clone 1 of Kreatur to have x-position 63 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(1).y, 96, 5, "Expected Clone 1 of Kreatur to have y-position 96 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(2).x, -204, 5, "Expected Clone 2 of Kreatur to have x-position -204 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(2).y, -137, 5, "Expected Clone 2 of Kreatur to have y-position -137 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(3).x, -205, 5, "Expected Clone 3 of Kreatur to have x-position -205 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(3).y, -176, 5, "Expected Clone 3 of Kreatur to have y-position -176 +-5");
...
const test1 = async function (t) {
  ...
  t.assert.equal(t.getSprite("Kreatur").getClone(2).volume, 100, "Expected Clone 2 of Kreatur to have volume 100");
  t.assert.equal(t.getSprite("Kreatur").getClone(3).volume, 100, "Expected Clone 3 of Kreatur to have volume 100");
  t.clickCloneByCoords(-205, -176, 1);
  await t.runForSteps(1);
  t.assert.equal(t.getStage().currentCostume, 0, "Expected backdrop 0");
  t.assert.equal(t.getSprite("Kreatur").currentCostume, 2, "Expected Sprite Kreatur to have costume 2");
  t.assert.equal(t.getSprite("Gobo").currentCostume, 0, "Expected Sprite Gobo to have costume 0");
  ...
  t.assert.equal(t.getSprite("Kreatur").getClone(2).volume, 100, "Expected Clone 2 of Kreatur to have volume 100");
  t.assert.equal(t.getSprite("Kreatur").getClone(3).volume, 100, "Expected Clone 3 of Kreatur to have volume 100");
  t.clickCloneByCoords(-204, -137, 1);
  await t.runForSteps(1);
  t.assert.equal(t.getStage().currentCostume, 0, "Expected backdrop 0");
  t.assert.equal(t.getSprite("Kreatur").currentCostume, 2, "Expected Sprite Kreatur to have costume 2");
  t.assert.equal(t.getSprite("Gobo").currentCostume, 0, "Expected Sprite Gobo to have costume 0");
  ...
  t.assert.withinRange(t.getSprite("Kreatur").getClone(2).x, -204, 5, "Expected Clone 2 of Kreatur to have x-position -204 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(2).y, -137, 5, "Expected Clone 2 of Kreatur to have y-position -137 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(3).x, 173, 5, "Expected Clone 3 of Kreatur to have x-position 173 +-5");
  ...
  t.assert.withinRange(t.getSprite("Kreatur").getClone(2).size, 70, 1, "Expected Clone 2 of Kreatur to have size 70 +-1");
...
const test2 = async function (t) {
  ...
  t.assert.withinRange(t.getSprite("Gobo").x, -110, 5, "Expected Sprite Gobo to have x-position -110 +-5");
  t.assert.withinRange(t.getSprite("Gobo").y, 110, 5, "Expected Sprite Gobo to have y-position 110 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(1).x, 99, 5, "Expected Clone 1 of Kreatur to have x-position 99 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(1).y, -154, 5, "Expected Clone 1 of Kreatur to have y-position -154 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(2).x, 123, 5, "Expected Clone 2 of Kreatur to have x-position 123 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(2).y, 155, 5, "Expected Clone 2 of Kreatur to have y-position 155 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(3).x, 231, 5, "Expected Clone 3 of Kreatur to have x-position 231 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(3).y, 1, 5, "Expected Clone 3 of Kreatur to have y-position 1 +-5");
  t.assert.not(t.getSprite("Kreatur").sayText, "Expected Sprite Kreatur not to say anything");
  t.assert.not(t.getSprite("Gobo").sayText, "Expected Sprite Gobo not to say anything");
  t.assert.not(t.getSprite("Kreatur").getClone(1).sayText, "Expected Clone 1 of Kreatur not to say anything");
  ...
  t.assert.withinRange(t.getSprite("Kreatur").size, 499, 1, "Expected Sprite Kreatur to have size 499 +-1");
  t.assert.withinRange(t.getSprite("Gobo").size, 60, 1, "Expected Sprite Gobo to have size 60 +-1");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(1).size, 74, 1, "Expected Clone 1 of Kreatur to have size 74 +-1");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(2).size, 86, 1, "Expected Clone 2 of Kreatur to have size 86 +-1");
  ...
  t.assert.withinRange(t.getSprite("Kreatur").getClone(2).x, 123, 5, "Expected Clone 2 of Kreatur to have x-position 123 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(2).y, 155, 5, "Expected Clone 2 of Kreatur to have y-position 155 +-5");
  t.assert.withinRange(t.getSprite("Kreatur").getClone(3).x, -8, 5, "Expected Clone 3 of Kreatur to have x-position -8 +-5");
