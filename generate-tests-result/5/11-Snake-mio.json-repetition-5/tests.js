const test0 = async function (t) {
  t.dragSprite('Punkt', 79.79579932244066, 94.05484139618085, null);
  ...
  t.assert.withinRange(t.getSprite("Körper").getClone(1).x, 78, 5, "Expected Clone 1 of Körper to have x-position 78 +-5");
...
const test1 = async function (t) {
  ...
  t.assert.withinRange(t.getSprite("Körper").x, 84, 5, "Expected Sprite Körper to have x-position 84 +-5");
  t.assert.withinRange(t.getSprite("Körper").y, 91, 5, "Expected Sprite Körper to have y-position 91 +-5");
  t.assert.withinRange(t.getSprite("Körper").getClone(1).x, 84, 5, "Expected Clone 1 of Körper to have x-position 84 +-5");
  t.assert.withinRange(t.getSprite("Körper").getClone(1).y, 91, 5, "Expected Clone 1 of Körper to have y-position 91 +-5");
  t.assert.not(t.getSprite("Körper").getClone(1).sayText, "Expected Clone 1 of Körper not to say anything");
  t.assert.withinRange(t.getSprite("Körper").getClone(1).size, 90, 1, "Expected Clone 1 of Körper to have size 90 +-1");
  t.assert.ok(t.getSprite("Körper").getClone(1).visible, "Expected Clone 1 of Körper to be visible");
  t.assert.equal(t.getSprite("Körper").getClone(1).volume, 100, "Expected Clone 1 of Körper to have volume 100");
  t.dragSprite('Punkt', 84, 88, null);
  await t.runForSteps(1);
  t.assert.equal(t.getSprite("Körper").getClone(1).currentCostume, 0, "Expected Clone 1 of Körper to have costume 0");
  t.assert.equal(t.getSprite("Körper").getClone(1).direction, 90, 1, "Expected Clone 1 of Körper to face in direction 90 +-1");
  t.assert.equal(t.getSprite("Körper").getClone(1).effects.color, 0, "Expected effect color of Clone 1 of Körper to be 0");
  ...
  t.assert.withinRange(t.getSprite("Körper").x, 84, 5, "Expected Sprite Körper to have x-position 84 +-5");
  t.assert.withinRange(t.getSprite("Körper").y, 88, 5, "Expected Sprite Körper to have y-position 88 +-5");
  t.assert.withinRange(t.getSprite("Punkt").x, -2, 5, "Expected Sprite Punkt to have x-position -2 +-5");
  t.assert.withinRange(t.getSprite("Punkt").y, 45, 5, "Expected Sprite Punkt to have y-position 45 +-5");
  t.assert.withinRange(t.getSprite("Körper").getClone(1).x, 84, 5, "Expected Clone 1 of Körper to have x-position 84 +-5");
  t.assert.withinRange(t.getSprite("Körper").getClone(1).y, 88, 5, "Expected Clone 1 of Körper to have y-position 88 +-5");
  t.assert.not(t.getSprite("Körper").getClone(1).sayText, "Expected Clone 1 of Körper not to say anything");
  t.assert.withinRange(t.getSprite("Körper").getClone(1).size, 90, 1, "Expected Clone 1 of Körper to have size 90 +-1");
  t.assert.ok(t.getSprite("Körper").getClone(1).visible, "Expected Clone 1 of Körper to be visible");
  t.assert.equal(t.getSprite("Körper").getClone(1).volume, 100, "Expected Clone 1 of Körper to have volume 100");
  ...
  t.assert.withinRange(t.getSprite("Körper").getClone(2).x, 84, 5, "Expected Clone 2 of Körper to have x-position 84 +-5");
  t.assert.withinRange(t.getSprite("Körper").getClone(2).y, 85, 5, "Expected Clone 2 of Körper to have y-position 85 +-5");
  t.assert.withinRange(t.getSprite("Körper").getClone(3).x, 84, 5, "Expected Clone 3 of Körper to have x-position 84 +-5");
  t.assert.withinRange(t.getSprite("Körper").getClone(3).y, 82, 5, "Expected Clone 3 of Körper to have y-position 82 +-5");
  ...
  t.assert.withinRange(t.getSprite("Kopf").y, 82, 5, "Expected Sprite Kopf to have y-position 82 +-5");
  t.assert.withinRange(t.getSprite("Körper").getClone(3).x, 81, 5, "Expected Clone 3 of Körper to have x-position 81 +-5");
  t.assert.withinRange(t.getSprite("Körper").getClone(3).y, 82, 5, "Expected Clone 3 of Körper to have y-position 82 +-5");
  t.assert.withinRange(t.getSprite("Körper").getClone(4).x, 78, 5, "Expected Clone 4 of Körper to have x-position 78 +-5");
  t.assert.withinRange(t.getSprite("Körper").getClone(4).y, 82, 5, "Expected Clone 4 of Körper to have y-position 82 +-5");
  t.assert.withinRange(t.getSprite("Körper").getClone(5).x, 81, 5, "Expected Clone 5 of Körper to have x-position 81 +-5");
  t.assert.withinRange(t.getSprite("Körper").getClone(5).y, 82, 5, "Expected Clone 5 of Körper to have y-position 82 +-5");
  t.assert.withinRange(t.getSprite("Körper").getClone(6).x, 84, 5, "Expected Clone 6 of Körper to have x-position 84 +-5");
  t.assert.withinRange(t.getSprite("Körper").getClone(6).y, 82, 5, "Expected Clone 6 of Körper to have y-position 82 +-5");
  ...
  t.assert.withinRange(t.getSprite("Körper").getClone(6).y, 91, 5, "Expected Clone 6 of Körper to have y-position 91 +-5");
  t.assert.not(t.getSprite("Körper").getClone(6).sayText, "Expected Clone 6 of Körper not to say anything");
  t.assert.withinRange(t.getSprite("Körper").getClone(6).size, 90, 1, "Expected Clone 6 of Körper to have size 90 +-1");
  t.assert.ok(t.getSprite("Körper").getClone(6).visible, "Expected Clone 6 of Körper to be visible");
  t.assert.equal(t.getSprite("Körper").getClone(6).volume, 100, "Expected Clone 6 of Körper to have volume 100");
  ...
  t.assert.withinRange(t.getSprite("Körper").x, 90, 5, "Expected Sprite Körper to have x-position 90 +-5");
  t.assert.withinRange(t.getSprite("Körper").y, 160, 5, "Expected Sprite Körper to have y-position 160 +-5");
  t.assert.not(t.getSprite("Kopf").sayText, "Expected Sprite Kopf not to say anything");
  t.end();
}
const test2 = async function (t) {
  t.dragSprite('Punkt', 82.16611802450305, 100.13961925149827, null);
  await t.runForSteps(1);
