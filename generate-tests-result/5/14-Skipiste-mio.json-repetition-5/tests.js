const test0 = async function (t) {
  ...
  t.assert.withinRange(t.getSprite("Hindernis").getClone(2).x, 157, 5, "Expected Clone 2 of Hindernis to have x-position 157 +-5");
...
const test1 = async function (t) {
  ...
  t.assert.equal(t.getSprite("Hindernis").getClone(1).getLayerOrder(), 1, "Expected Clone 1 of Hindernis to be at layer 1");
  t.assert.withinRange(t.getSprite("Skikatze").x, -6, 5, "Expected Sprite Skikatze to have x-position -6 +-5");
  t.assert.withinRange(t.getSprite("Skikatze").y, 100, 5, "Expected Sprite Skikatze to have y-position 100 +-5");
  t.assert.withinRange(t.getSprite("Hindernis").getClone(1).x, -27, 5, "Expected Clone 1 of Hindernis to have x-position -27 +-5");
...
const test2 = async function (t) {
  ...
  await t.runForSteps(3);
  await t.runForSteps(1);
  t.dragSprite('Skikatze', -93.76089160955284, -117.7895092375975, null);
  await t.runForSteps(1);
  t.assert.withinRange(t.getSprite("Skikatze").x, -93.76089160955284, 5, "Expected Sprite Skikatze to have x-position -93.76089160955284 +-5");
  t.assert.withinRange(t.getSprite("Skikatze").y, -117.7895092375975, 5, "Expected Sprite Skikatze to have y-position -117.7895092375975 +-5");
  await t.runForSteps(66);
  await t.runForSteps(1);
  t.assert.equal(t.getSprite("Skikatze").currentCostume, 1, "Expected Sprite Skikatze to have costume 1");
  t.assert.equal(t.getSprite("Hindernis").currentCostume, 0, "Expected Sprite Hindernis to have costume 0");
  t.assert.withinRange(t.getSprite("Skikatze").x, -79.76089160955284, 5, "Expected Sprite Skikatze to have x-position -79.76089160955284 +-5");
  t.assert.withinRange(t.getSprite("Skikatze").y, -117.7895092375975, 5, "Expected Sprite Skikatze to have y-position -117.7895092375975 +-5");
  t.end();
}
