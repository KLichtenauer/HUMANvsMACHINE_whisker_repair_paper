const test0 = async function (t) {
  t.dragSprite('Aus-Linie Computer', -56.094339290969245, -180, null);
  ...
  t.assert.equal(t.getSprite("Ball").direction, 45, 1, "Expected Sprite Ball to face in direction 45 +-1");
  ...
  t.assert.withinRange(t.getSprite("Ball").x, -92.92893218813452, 5, "Expected Sprite Ball to have x-position -92.92893218813452 +-5");
  t.assert.withinRange(t.getSprite("Ball").y, 7.071067811865475, 5, "Expected Sprite Ball to have y-position 7.071067811865475 +-5");
  ...
  t.dragSprite('Aus-Linie Computer', -90.80017056064027, 17.01069990634168, null);
  await t.runForSteps(1);
  t.assert.equal(t.getStage().currentCostume, 0, "Expected backdrop 0");
  t.assert.equal(t.getSprite("Ball").currentCostume, 5, "Expected Sprite Ball to have costume 5");
  t.assert.equal(t.getSprite("Spieler").currentCostume, 0, "Expected Sprite Spieler to have costume 0");
  ...
  t.assert.equal(t.getSprite("Aus-Linie Computer").layerOrder, 1, "Expected Sprite Aus-Linie Computer to be at layer 1");
  t.assert.equal(t.getSprite("Reset-Button").layerOrder, 6, "Expected Sprite Reset-Button to be at layer 6");
  t.assert.withinRange(t.getSprite("Ball").x, -85.85786437626905, 5, "Expected Sprite Ball to have x-position -85.85786437626905 +-5");
  t.assert.withinRange(t.getSprite("Ball").y, 14.14213562373095, 5, "Expected Sprite Ball to have y-position 14.14213562373095 +-5");
  t.assert.withinRange(t.getSprite("Spieler").x, -210, 5, "Expected Sprite Spieler to have x-position -210 +-5");
  t.assert.withinRange(t.getSprite("Spieler").y, -89, 5, "Expected Sprite Spieler to have y-position -89 +-5");
  t.assert.withinRange(t.getSprite("Aus-Linie Spieler").x, -30, 5, "Expected Sprite Aus-Linie Spieler to have x-position -30 +-5");
  t.assert.withinRange(t.getSprite("Aus-Linie Spieler").y, 25, 5, "Expected Sprite Aus-Linie Spieler to have y-position 25 +-5");
  ...
  t.assert.withinRange(t.getSprite("Aus-Linie Computer").y, 17.01069990634168, 5, "Expected Sprite Aus-Linie Computer to have y-position 17.01069990634168 +-5");
  t.assert.withinRange(t.getSprite("Reset-Button").x, 0, 5, "Expected Sprite Reset-Button to have x-position 0 +-5");
  t.assert.withinRange(t.getSprite("Reset-Button").y, 140, 5, "Expected Sprite Reset-Button to have y-position 140 +-5");
  t.assert.not(t.getSprite("Ball").sayText, "Expected Sprite Ball not to say anything");
  t.assert.not(t.getSprite("Spieler").sayText, "Expected Sprite Spieler not to say anything");
  ...
  t.assert.equal(t.getSprite("Aus-Linie Computer").volume, 100, "Expected Sprite Aus-Linie Computer to have volume 100");
  t.assert.equal(t.getSprite("Reset-Button").volume, 100, "Expected Sprite Reset-Button to have volume 100");
  t.dragSprite('Aus-Linie Computer', -85.50714707300317, -180, null);
  await t.runForSteps(1);
  t.assert.equal(t.getStage().currentCostume, 0, "Expected backdrop 0");
  t.assert.equal(t.getSprite("Ball").currentCostume, 5, "Expected Sprite Ball to have costume 5");
  t.assert.equal(t.getSprite("Spieler").currentCostume, 0, "Expected Sprite Spieler to have costume 0");
  ...
  t.assert.equal(t.getSprite("Aus-Linie Computer").layerOrder, 1, "Expected Sprite Aus-Linie Computer to be at layer 1");
  t.assert.equal(t.getSprite("Reset-Button").layerOrder, 6, "Expected Sprite Reset-Button to be at layer 6");
  t.assert.withinRange(t.getSprite("Ball").x, -78.78679656440357, 5, "Expected Sprite Ball to have x-position -78.78679656440357 +-5");
  t.assert.withinRange(t.getSprite("Ball").y, 21.213203435596423, 5, "Expected Sprite Ball to have y-position 21.213203435596423 +-5");
  t.assert.withinRange(t.getSprite("Spieler").x, -210, 5, "Expected Sprite Spieler to have x-position -210 +-5");
  t.assert.withinRange(t.getSprite("Spieler").y, -89, 5, "Expected Sprite Spieler to have y-position -89 +-5");
  t.assert.withinRange(t.getSprite("Aus-Linie Spieler").x, -30, 5, "Expected Sprite Aus-Linie Spieler to have x-position -30 +-5");
  t.assert.withinRange(t.getSprite("Aus-Linie Spieler").y, 25, 5, "Expected Sprite Aus-Linie Spieler to have y-position 25 +-5");
  ...
  t.assert.equal(t.getSprite("Aus-Linie Computer").layerOrder, 1, "Expected Sprite Aus-Linie Computer to be at layer 1");
  t.assert.equal(t.getSprite("Reset-Button").layerOrder, 6, "Expected Sprite Reset-Button to be at layer 6");
  t.assert.withinRange(t.getSprite("Ball").x, -43.431457505076196, 5, "Expected Sprite Ball to have x-position -43.431457505076196 +-5");
  t.assert.withinRange(t.getSprite("Ball").y, 56.5685424949238, 5, "Expected Sprite Ball to have y-position 56.5685424949238 +-5");
  t.assert.withinRange(t.getSprite("Spieler").x, -210, 5, "Expected Sprite Spieler to have x-position -210 +-5");
  ...
  t.assert.equal(t.getSprite("Aus-Linie Computer").layerOrder, 1, "Expected Sprite Aus-Linie Computer to be at layer 1");
  t.assert.equal(t.getSprite("Reset-Button").layerOrder, 6, "Expected Sprite Reset-Button to be at layer 6");
  t.assert.withinRange(t.getSprite("Ball").x, -29.289321881345245, 5, "Expected Sprite Ball to have x-position -29.289321881345245 +-5");
  t.assert.withinRange(t.getSprite("Ball").y, 70.71067811865474, 5, "Expected Sprite Ball to have y-position 70.71067811865474 +-5");
  t.assert.withinRange(t.getSprite("Spieler").x, -210, 5, "Expected Sprite Spieler to have x-position -210 +-5");
  ...
  t.assert.equal(t.getSprite("Aus-Linie Computer").getCloneCount(), 0, "Expected Sprite Aus-Linie Computer to have 0 clones");
  t.assert.equal(t.getSprite("Reset-Button").getCloneCount(), 0, "Expected Sprite Reset-Button to have 0 clones");
  t.assert.equal(t.getSprite("Ball").direction, -135, 1, "Expected Sprite Ball to face in direction -135 +-1");
  t.assert.equal(t.getSprite("Spieler").direction, 180, 1, "Expected Sprite Spieler to face in direction 180 +-1");
  t.assert.equal(t.getSprite("Aus-Linie Spieler").direction, 180, 1, "Expected Sprite Aus-Linie Spieler to face in direction 180 +-1");
  t.assert.equal(t.getSprite("Computer").direction, 180, 1, "Expected Sprite Computer to face in direction 180 +-1");
  t.assert.equal(t.getSprite("Aus-Linie Computer").direction, 180, 1, "Expected Sprite Aus-Linie Computer to face in direction 180 +-1");
  ...
  t.assert.equal(t.getSprite("Aus-Linie Computer").layerOrder, 1, "Expected Sprite Aus-Linie Computer to be at layer 1");
  t.assert.equal(t.getSprite("Reset-Button").layerOrder, 6, "Expected Sprite Reset-Button to be at layer 6");
  t.assert.withinRange(t.getSprite("Ball").x, 20.208152801713084, 5, "Expected Sprite Ball to have x-position 20.208152801713084 +-5");
  t.assert.withinRange(t.getSprite("Ball").y, -121.23777011128341, 5, "Expected Sprite Ball to have y-position -121.23777011128341 +-5");
  t.assert.withinRange(t.getSprite("Spieler").x, -210, 5, "Expected Sprite Spieler to have x-position -210 +-5");
  t.assert.withinRange(t.getSprite("Spieler").y, -134, 5, "Expected Sprite Spieler to have y-position -134 +-5");
  t.assert.withinRange(t.getSprite("Aus-Linie Spieler").x, -30, 5, "Expected Sprite Aus-Linie Spieler to have x-position -30 +-5");
  t.assert.withinRange(t.getSprite("Aus-Linie Spieler").y, 25, 5, "Expected Sprite Aus-Linie Spieler to have y-position 25 +-5");
  t.assert.withinRange(t.getSprite("Computer").x, 207, 5, "Expected Sprite Computer to have x-position 207 +-5");
  t.assert.withinRange(t.getSprite("Computer").y, -99.73333333333335, 5, "Expected Sprite Computer to have y-position -99.73333333333335 +-5");
  t.assert.withinRange(t.getSprite("Aus-Linie Computer").x, -26, 5, "Expected Sprite Aus-Linie Computer to have x-position -26 +-5");
  t.assert.withinRange(t.getSprite("Aus-Linie Computer").y, -180, 5, "Expected Sprite Aus-Linie Computer to have y-position -180 +-5");
  t.assert.withinRange(t.getSprite("Reset-Button").x, 0, 5, "Expected Sprite Reset-Button to have x-position 0 +-5");
  t.assert.withinRange(t.getSprite("Reset-Button").y, 140, 5, "Expected Sprite Reset-Button to have y-position 140 +-5");
  ...
  t.assert.equal(t.getSprite("Aus-Linie Computer").volume, 100, "Expected Sprite Aus-Linie Computer to have volume 100");
  t.assert.equal(t.getSprite("Reset-Button").volume, 100, "Expected Sprite Reset-Button to have volume 100");
  t.dragSprite('Aus-Linie Computer', 20.755192151393484, 180, null);
  await t.runForSteps(1);
  t.assert.equal(t.getStage().currentCostume, 0, "Expected backdrop 0");
  t.assert.equal(t.getSprite("Ball").currentCostume, 5, "Expected Sprite Ball to have costume 5");
  t.assert.equal(t.getSprite("Spieler").currentCostume, 0, "Expected Sprite Spieler to have costume 0");
  ...
  t.assert.equal(t.getSprite("Aus-Linie Computer").layerOrder, 1, "Expected Sprite Aus-Linie Computer to be at layer 1");
  t.assert.equal(t.getSprite("Reset-Button").layerOrder, 6, "Expected Sprite Reset-Button to be at layer 6");
  t.assert.withinRange(t.getSprite("Ball").x, 13.137084989847606, 5, "Expected Sprite Ball to have x-position 13.137084989847606 +-5");
  t.assert.withinRange(t.getSprite("Ball").y, -128.30883792314887, 5, "Expected Sprite Ball to have y-position -128.30883792314887 +-5");
  t.assert.withinRange(t.getSprite("Spieler").x, -210, 5, "Expected Sprite Spieler to have x-position -210 +-5");
  t.assert.withinRange(t.getSprite("Spieler").y, -134, 5, "Expected Sprite Spieler to have y-position -134 +-5");
  t.assert.withinRange(t.getSprite("Aus-Linie Spieler").x, -30, 5, "Expected Sprite Aus-Linie Spieler to have x-position -30 +-5");
  t.assert.withinRange(t.getSprite("Aus-Linie Spieler").y, 25, 5, "Expected Sprite Aus-Linie Spieler to have y-position 25 +-5");
  ...
  t.assert.withinRange(t.getSprite("Aus-Linie Computer").x, 20.755192151393484, 5, "Expected Sprite Aus-Linie Computer to have x-position 20.755192151393484 +-5");
  t.assert.withinRange(t.getSprite("Aus-Linie Computer").y, 180, 5, "Expected Sprite Aus-Linie Computer to have y-position 180 +-5");
  t.assert.withinRange(t.getSprite("Reset-Button").x, 0, 5, "Expected Sprite Reset-Button to have x-position 0 +-5");
  t.assert.withinRange(t.getSprite("Reset-Button").y, 140, 5, "Expected Sprite Reset-Button to have y-position 140 +-5");
  t.assert.not(t.getSprite("Ball").sayText, "Expected Sprite Ball not to say anything");
  ...
  t.assert.equal(t.getSprite("Aus-Linie Computer").layerOrder, 1, "Expected Sprite Aus-Linie Computer to be at layer 1");
  t.assert.equal(t.getSprite("Reset-Button").layerOrder, 6, "Expected Sprite Reset-Button to be at layer 6");
  t.assert.withinRange(t.getSprite("Ball").x, -184.8528137423857, 5, "Expected Sprite Ball to have x-position -184.8528137423857 +-5");
  t.assert.withinRange(t.getSprite("Ball").y, 30.284271247461902, 5, "Expected Sprite Ball to have y-position 30.284271247461902 +-5");
  t.assert.withinRange(t.getSprite("Spieler").x, -210, 5, "Expected Sprite Spieler to have x-position -210 +-5");
  t.assert.withinRange(t.getSprite("Spieler").y, -134, 5, "Expected Sprite Spieler to have y-position -134 +-5");
  t.assert.withinRange(t.getSprite("Aus-Linie Spieler").x, -30, 5, "Expected Sprite Aus-Linie Spieler to have x-position -30 +-5");
  t.assert.withinRange(t.getSprite("Aus-Linie Spieler").y, 25, 5, "Expected Sprite Aus-Linie Spieler to have y-position 25 +-5");
  t.assert.withinRange(t.getSprite("Computer").x, 207, 5, "Expected Sprite Computer to have x-position 207 +-5");
  t.assert.withinRange(t.getSprite("Computer").y, 81.60000000000002, 5, "Expected Sprite Computer to have y-position 81.60000000000002 +-5");
  t.assert.withinRange(t.getSprite("Aus-Linie Computer").x, 20.755192151393484, 5, "Expected Sprite Aus-Linie Computer to have x-position 20.755192151393484 +-5");
  t.assert.withinRange(t.getSprite("Aus-Linie Computer").y, 180, 5, "Expected Sprite Aus-Linie Computer to have y-position 180 +-5");
  t.assert.withinRange(t.getSprite("Reset-Button").x, 0, 5, "Expected Sprite Reset-Button to have x-position 0 +-5");
  t.assert.withinRange(t.getSprite("Reset-Button").y, 140, 5, "Expected Sprite Reset-Button to have y-position 140 +-5");
...
const test1 = async function (t) {
  ...
  t.assert.equal(t.getSprite("Aus-Linie Computer").volume, 100, "Expected Sprite Aus-Linie Computer to have volume 100");
  t.assert.equal(t.getSprite("Reset-Button").volume, 100, "Expected Sprite Reset-Button to have volume 100");
  t.dragSprite('Aus-Linie Computer', -84.16640147573277, 180, null);
  await t.runForSteps(1);
  t.assert.equal(t.getStage().currentCostume, 0, "Expected backdrop 0");
  t.assert.equal(t.getSprite("Ball").currentCostume, 5, "Expected Sprite Ball to have costume 5");
  t.assert.equal(t.getSprite("Spieler").currentCostume, 0, "Expected Sprite Spieler to have costume 0");
  ...
  t.assert.equal(t.getSprite("Aus-Linie Computer").volume, 100, "Expected Sprite Aus-Linie Computer to have volume 100");
  t.assert.equal(t.getSprite("Reset-Button").volume, 100, "Expected Sprite Reset-Button to have volume 100");
  t.dragSprite('Aus-Linie Computer', -77.53111787614577, -180, null);
  await t.runForSteps(1);
  t.assert.equal(t.getStage().currentCostume, 0, "Expected backdrop 0");
  t.assert.equal(t.getSprite("Ball").currentCostume, 5, "Expected Sprite Ball to have costume 5");
  t.assert.equal(t.getSprite("Spieler").currentCostume, 0, "Expected Sprite Spieler to have costume 0");
  ...
  t.assert.equal(t.getSprite("Aus-Linie Computer").layerOrder, 1, "Expected Sprite Aus-Linie Computer to be at layer 1");
  t.assert.equal(t.getSprite("Reset-Button").layerOrder, 6, "Expected Sprite Reset-Button to be at layer 6");
  t.assert.withinRange(t.getSprite("Ball").x, -71.7157287525381, 5, "Expected Sprite Ball to have x-position -71.7157287525381 +-5");
  t.assert.withinRange(t.getSprite("Ball").y, 28.2842712474619, 5, "Expected Sprite Ball to have y-position 28.2842712474619 +-5");
  t.assert.withinRange(t.getSprite("Spieler").x, -210, 5, "Expected Sprite Spieler to have x-position -210 +-5");
  t.assert.withinRange(t.getSprite("Spieler").y, -104, 5, "Expected Sprite Spieler to have y-position -104 +-5");
  t.assert.withinRange(t.getSprite("Aus-Linie Spieler").x, -30, 5, "Expected Sprite Aus-Linie Spieler to have x-position -30 +-5");
  t.assert.withinRange(t.getSprite("Aus-Linie Spieler").y, 25, 5, "Expected Sprite Aus-Linie Spieler to have y-position 25 +-5");
  ...
  t.assert.equal(t.getSprite("Aus-Linie Computer").volume, 100, "Expected Sprite Aus-Linie Computer to have volume 100");
  t.assert.equal(t.getSprite("Reset-Button").volume, 100, "Expected Sprite Reset-Button to have volume 100");
  t.dragSprite('Ball', -194.98108807434008, -38.119170253772936, null);
  await t.runForSteps(1);
  t.assert.equal(t.getStage().currentCostume, 1, "Expected backdrop 1");
  t.assert.equal(t.getSprite("Ball").currentCostume, 5, "Expected Sprite Ball to have costume 5");
  t.assert.equal(t.getSprite("Spieler").currentCostume, 0, "Expected Sprite Spieler to have costume 0");
  ...
  t.assert.equal(t.getSprite("Aus-Linie Computer").layerOrder, 1, "Expected Sprite Aus-Linie Computer to be at layer 1");
  t.assert.equal(t.getSprite("Reset-Button").layerOrder, 6, "Expected Sprite Reset-Button to be at layer 6");
  t.assert.withinRange(t.getSprite("Ball").x, -202.05215588620555, 5, "Expected Sprite Ball to have x-position -202.05215588620555 +-5");
  t.assert.withinRange(t.getSprite("Ball").y, -16.90596681817651, 5, "Expected Sprite Ball to have y-position -16.90596681817651 +-5");
  t.assert.withinRange(t.getSprite("Spieler").x, -210, 5, "Expected Sprite Spieler to have x-position -210 +-5");
  t.assert.withinRange(t.getSprite("Spieler").y, -104, 5, "Expected Sprite Spieler to have y-position -104 +-5");
  t.assert.withinRange(t.getSprite("Aus-Linie Spieler").x, -30, 5, "Expected Sprite Aus-Linie Spieler to have x-position -30 +-5");
  t.assert.withinRange(t.getSprite("Aus-Linie Spieler").y, 25, 5, "Expected Sprite Aus-Linie Spieler to have y-position 25 +-5");
  ...
  t.assert.equal(t.getSprite("Aus-Linie Computer").volume, 100, "Expected Sprite Aus-Linie Computer to have volume 100");
  t.assert.equal(t.getSprite("Reset-Button").volume, 100, "Expected Sprite Reset-Button to have volume 100");
  t.dragSprite('Ball', 140.86375355643932, 31.881273480558377, null);
  await t.runForSteps(1);
  t.assert.equal(t.getStage().currentCostume, 1, "Expected backdrop 1");
  t.assert.equal(t.getSprite("Ball").currentCostume, 5, "Expected Sprite Ball to have costume 5");
  t.assert.equal(t.getSprite("Spieler").currentCostume, 0, "Expected Sprite Spieler to have costume 0");
  ...
  t.assert.equal(t.getSprite("Aus-Linie Computer").layerOrder, 1, "Expected Sprite Aus-Linie Computer to be at layer 1");
  t.assert.equal(t.getSprite("Reset-Button").layerOrder, 6, "Expected Sprite Reset-Button to be at layer 6");
  t.assert.withinRange(t.getSprite("Ball").x, 133.79268574457384, 5, "Expected Sprite Ball to have x-position 133.79268574457384 +-5");
  t.assert.withinRange(t.getSprite("Ball").y, 38.95234129242385, 5, "Expected Sprite Ball to have y-position 38.95234129242385 +-5");
  t.assert.withinRange(t.getSprite("Spieler").x, -210, 5, "Expected Sprite Spieler to have x-position -210 +-5");
  t.assert.withinRange(t.getSprite("Spieler").y, -104, 5, "Expected Sprite Spieler to have y-position -104 +-5");
  t.assert.withinRange(t.getSprite("Aus-Linie Spieler").x, -30, 5, "Expected Sprite Aus-Linie Spieler to have x-position -30 +-5");
  t.assert.withinRange(t.getSprite("Aus-Linie Spieler").y, 25, 5, "Expected Sprite Aus-Linie Spieler to have y-position 25 +-5");
  ...
  t.assert.equal(t.getSprite("Aus-Linie Computer").layerOrder, 1, "Expected Sprite Aus-Linie Computer to be at layer 1");
  t.assert.equal(t.getSprite("Reset-Button").layerOrder, 6, "Expected Sprite Reset-Button to be at layer 6");
  t.assert.withinRange(t.getSprite("Ball").x, 126.72161793270837, 5, "Expected Sprite Ball to have x-position 126.72161793270837 +-5");
  t.assert.withinRange(t.getSprite("Ball").y, 46.02340910428933, 5, "Expected Sprite Ball to have y-position 46.02340910428933 +-5");
  t.assert.withinRange(t.getSprite("Spieler").x, -210, 5, "Expected Sprite Spieler to have x-position -210 +-5");
  t.assert.withinRange(t.getSprite("Spieler").y, -104, 5, "Expected Sprite Spieler to have y-position -104 +-5");
  t.assert.withinRange(t.getSprite("Aus-Linie Spieler").x, -30, 5, "Expected Sprite Aus-Linie Spieler to have x-position -30 +-5");
  t.assert.withinRange(t.getSprite("Aus-Linie Spieler").y, 25, 5, "Expected Sprite Aus-Linie Spieler to have y-position 25 +-5");
  ...
  t.assert.equal(t.getSprite("Aus-Linie Computer").volume, 100, "Expected Sprite Aus-Linie Computer to have volume 100");
  t.assert.equal(t.getSprite("Reset-Button").volume, 100, "Expected Sprite Reset-Button to have volume 100");
  t.dragSprite('Ball', -158.2048475722587, -146.91586762090395, null);
  await t.runForSteps(1);
  t.assert.equal(t.getStage().currentCostume, 1, "Expected backdrop 1");
  t.assert.equal(t.getSprite("Ball").currentCostume, 5, "Expected Sprite Ball to have costume 5");
  t.assert.equal(t.getSprite("Spieler").currentCostume, 0, "Expected Sprite Spieler to have costume 0");
  ...
  t.assert.equal(t.getSprite("Aus-Linie Computer").layerOrder, 1, "Expected Sprite Aus-Linie Computer to be at layer 1");
  t.assert.equal(t.getSprite("Reset-Button").layerOrder, 6, "Expected Sprite Reset-Button to be at layer 6");
  t.assert.withinRange(t.getSprite("Ball").x, -151.13377976039322, 5, "Expected Sprite Ball to have x-position -151.13377976039322 +-5");
  t.assert.withinRange(t.getSprite("Ball").y, -125.67304687573721, 5, "Expected Sprite Ball to have y-position -125.67304687573721 +-5");
  t.assert.withinRange(t.getSprite("Spieler").x, -210, 5, "Expected Sprite Spieler to have x-position -210 +-5");
  t.assert.withinRange(t.getSprite("Spieler").y, -104, 5, "Expected Sprite Spieler to have y-position -104 +-5");
  t.assert.withinRange(t.getSprite("Aus-Linie Spieler").x, -30, 5, "Expected Sprite Aus-Linie Spieler to have x-position -30 +-5");
  t.assert.withinRange(t.getSprite("Aus-Linie Spieler").y, 25, 5, "Expected Sprite Aus-Linie Spieler to have y-position 25 +-5");
