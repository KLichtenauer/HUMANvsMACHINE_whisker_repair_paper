const test0 = async function (t) {
  t.dragSprite('Spieler', -155.96257732505006, -63.058256577485395, null);
  ...
  t.assert.withinRange(t.getSprite("Münzen").x, -5, 5, "Expected Sprite Münzen to have x-position -5 +-5");
  ...
  t.assert.equal(t.getSprite("Münzen").layerOrder, 4, "Expected Sprite Münzen to be at layer 4");
  t.assert.equal(t.getSprite("Eis").layerOrder, 2, "Expected Sprite Eis to be at layer 2");
  t.assert.withinRange(t.getSprite("Spieler").x, -186, 5, "Expected Sprite Spieler to have x-position -186 +-5");
...
const test1 = async function (t) {
  ...
  t.assert.withinRange(t.getSprite("Spieler").y, -95, 5, "Expected Sprite Spieler to have y-position -95 +-5");
  t.assert.withinRange(t.getSprite("Freundin").x, 60, 5, "Expected Sprite Freundin to have x-position 60 +-5");
  t.assert.withinRange(t.getSprite("Freundin").y, -131, 5, "Expected Sprite Freundin to have y-position -131 +-5");
  t.assert.withinRange(t.getSprite("Münzen").x, -5, 5, "Expected Sprite Münzen to have x-position -5 +-5");
  t.assert.withinRange(t.getSprite("Münzen").y, 130, 5, "Expected Sprite Münzen to have y-position 130 +-5");
...
const test2 = async function (t) {
  ...
  t.assert.equal(t.getSprite("Münzen").volume, 100, "Expected Sprite Münzen to have volume 100");
  t.assert.equal(t.getSprite("Eis").volume, 100, "Expected Sprite Eis to have volume 100");
  t.dragSprite('Spieler', 184.5609371480865, -137.8069365610785, null);
  await t.runForSteps(1);
  t.assert.equal(t.getStage().currentCostume, 0, "Expected backdrop 0");
  t.assert.equal(t.getSprite("Spieler").currentCostume, 0, "Expected Sprite Spieler to have costume 0");
  t.assert.equal(t.getSprite("Freundin").currentCostume, 0, "Expected Sprite Freundin to have costume 0");
  ...
  t.assert.equal(t.getSprite("Münzen").layerOrder, 4, "Expected Sprite Münzen to be at layer 4");
  t.assert.equal(t.getSprite("Eis").layerOrder, 2, "Expected Sprite Eis to be at layer 2");
  t.assert.withinRange(t.getSprite("Spieler").x, 184.5609371480865, 5, "Expected Sprite Spieler to have x-position 184.5609371480865 +-5");
  t.assert.withinRange(t.getSprite("Spieler").y, -137.8069365610785, 5, "Expected Sprite Spieler to have y-position -137.8069365610785 +-5");
  t.assert.withinRange(t.getSprite("Freundin").x, 60, 5, "Expected Sprite Freundin to have x-position 60 +-5");
  t.assert.withinRange(t.getSprite("Freundin").y, -131, 5, "Expected Sprite Freundin to have y-position -131 +-5");
  t.assert.withinRange(t.getSprite("Münzen").x, -5, 5, "Expected Sprite Münzen to have x-position -5 +-5");
  t.assert.withinRange(t.getSprite("Münzen").y, 130, 5, "Expected Sprite Münzen to have y-position 130 +-5");
  ...
  t.assert.equal(t.getSprite("Münzen").volume, 100, "Expected Sprite Münzen to have volume 100");
  t.assert.equal(t.getSprite("Eis").volume, 100, "Expected Sprite Eis to have volume 100");
  t.dragSprite('Münzen', 184, -137, null);
  await t.runForSteps(1);
  t.assert.equal(t.getStage().currentCostume, 0, "Expected backdrop 0");
  t.assert.equal(t.getSprite("Spieler").currentCostume, 0, "Expected Sprite Spieler to have costume 0");
  t.assert.equal(t.getSprite("Freundin").currentCostume, 0, "Expected Sprite Freundin to have costume 0");
  ...
  t.assert.withinRange(t.getSprite("Freundin").x, 60, 5, "Expected Sprite Freundin to have x-position 60 +-5");
  t.assert.withinRange(t.getSprite("Freundin").y, -131, 5, "Expected Sprite Freundin to have y-position -131 +-5");
  t.assert.withinRange(t.getSprite("Münzen").x, 184, 5, "Expected Sprite Münzen to have x-position 184 +-5");
  t.assert.withinRange(t.getSprite("Münzen").y, -137, 5, "Expected Sprite Münzen to have y-position -137 +-5");
  t.assert.withinRange(t.getSprite("Eis").x, 195, 5, "Expected Sprite Eis to have x-position 195 +-5");
  t.assert.withinRange(t.getSprite("Eis").y, -158, 5, "Expected Sprite Eis to have y-position -158 +-5");
  t.assert.not(t.getSprite("Spieler").sayText, "Expected Sprite Spieler not to say anything");
...
const test3 = async function (t) {
  ...
  t.assert.equal(t.getSprite("Münzen").volume, 100, "Expected Sprite Münzen to have volume 100");
  t.assert.equal(t.getSprite("Eis").volume, 100, "Expected Sprite Eis to have volume 100");
  t.dragSprite('Spieler', 210.53325454000375, -145.8991523225079, null);
  await t.runForSteps(1);
  t.assert.equal(t.getStage().currentCostume, 0, "Expected backdrop 0");
  t.assert.equal(t.getSprite("Spieler").currentCostume, 0, "Expected Sprite Spieler to have costume 0");
  t.assert.equal(t.getSprite("Freundin").currentCostume, 0, "Expected Sprite Freundin to have costume 0");
  ...
  t.assert.equal(t.getSprite("Münzen").layerOrder, 4, "Expected Sprite Münzen to be at layer 4");
  t.assert.equal(t.getSprite("Eis").layerOrder, 2, "Expected Sprite Eis to be at layer 2");
  t.assert.withinRange(t.getSprite("Spieler").x, 210.53325454000375, 5, "Expected Sprite Spieler to have x-position 210.53325454000375 +-5");
  t.assert.withinRange(t.getSprite("Spieler").y, -145.8991523225079, 5, "Expected Sprite Spieler to have y-position -145.8991523225079 +-5");
  t.assert.withinRange(t.getSprite("Freundin").x, 60, 5, "Expected Sprite Freundin to have x-position 60 +-5");
  t.assert.withinRange(t.getSprite("Freundin").y, -131, 5, "Expected Sprite Freundin to have y-position -131 +-5");
  t.assert.withinRange(t.getSprite("Münzen").x, -5, 5, "Expected Sprite Münzen to have x-position -5 +-5");
  t.assert.withinRange(t.getSprite("Münzen").y, 130, 5, "Expected Sprite Münzen to have y-position 130 +-5");
