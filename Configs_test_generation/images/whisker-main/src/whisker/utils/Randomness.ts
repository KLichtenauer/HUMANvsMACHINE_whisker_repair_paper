...
export class Randomness {
    ...
    // Based on https://github.com/squaresLab/genprog4java/blob/c1ab6e01a9dc5d5db682fa0a85c5656bc3215b7b/src/clegoues/util/GlobalUtils.java#L97
    public withProbability(p: number): boolean {
        if (p < 0) {
            return false;
        }
        ...
        return Randomness._instance.nextDouble() < p;
    }
