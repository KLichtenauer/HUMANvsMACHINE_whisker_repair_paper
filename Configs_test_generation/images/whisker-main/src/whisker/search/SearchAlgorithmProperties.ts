 ...
 */
export interface RandomSearchProperties<C extends Chromosome> extends CommonProperties<C> {
    // Only used for repair, tells how many fitness evaluations to perform in parallel.
    numberOfJobs?: number;
}
...
export interface RepairProperties<C extends RepairChromosome> extends GeneticAlgorithmProperties<C> {

    /**
     * How many chromosomes to evaluate in parallel.
     */
    numberOfJobs: number;

    operatorOrder: "crossover then mutation" | "mutation then crossover";
