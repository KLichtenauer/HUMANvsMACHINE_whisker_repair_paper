...
import {CSVSchema} from "../../../repair/utils/CSVSchema";
 ...
 */
export abstract class SearchAlgorithmDefault<C extends Chromosome> extends EventEmitter implements SearchAlgorithm<C> {
     ...
     */
    protected async updateArchive(candidateChromosome: C): Promise<void> {
    ...
    declare emit: C extends RepairChromosome
        ? (eventName: "evaluation", args: CSVSchema) => boolean
        : typeof EventEmitter.prototype.emit
        ;

    declare listenerCount: C extends RepairChromosome
        ? (eventName: "evaluation") => number
        : typeof EventEmitter.prototype.listenerCount
        ;
}
