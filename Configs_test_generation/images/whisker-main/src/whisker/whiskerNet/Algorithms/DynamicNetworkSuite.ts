...
import {Mutant} from "../../scratch/ScratchMutation/ScratchMutation";
...
export class DynamicNetworkSuite {
     ...
     */
    protected async mutationAnalysis(): Promise<Mutant[]> {
     ...
     */
    protected async execute(): Promise<[string, Mutant[]]> {
     ...
     */
    protected async loadMutant(mutant: Mutant): Promise<void> {
