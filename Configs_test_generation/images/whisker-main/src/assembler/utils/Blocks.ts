import {List, Multiple, Scalar, Variable} from "../types/blocks/categories/Data";
import {Block, BlockID, isBlockID, ScratchBlock} from "../types/blocks/Block";
import {Input, InputKey, isTopLevelDataBlock} from "../types/blocks/Inputs";
...
export function getOpcode(block: ScratchBlock): Opcode | null {
    return isStackBlock(block) ? block.opcode : null;
}
