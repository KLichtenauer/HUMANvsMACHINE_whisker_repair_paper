 ...
 */
export abstract class Crossover<C extends Chromosome> extends EventEmitter {
    ...
    static identity<C extends Chromosome>(): Crossover<C> {
        return new class extends Crossover<C> {
            apply(parent1: C, parent2: C): Pair<C> {
                return [parent1.clone() as C, parent2.clone() as C];
            }
        };
    }
}
