...
# terminal [1], [2]. For example, use the --compat flag:
#
#   apptainer run --compat whisker.sif
#
# Sometimes, this does not work. In this case, you can try to bypass the
# ENTRYPOINT defined in the Dockerfile and run Whisker directly:
#
#   apptainer exec whisker.sif /whisker/servant/whisker-docker.sh
#
# [1] https://apptainer.org/docs/user/1.1/docker_and_oci.html#init-shim-process
# [2]# https://apptainer.org/docs/user/main/docker_and_oci.html#docker-like-compat-flag
