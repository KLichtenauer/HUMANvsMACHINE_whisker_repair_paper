const test0 = async function (t) {
  ...
  t.assert.withinRange(t.getSprite("Pirat").x, -65.92592592592592, 5, "Expected Sprite Pirat to have x-position -65.92592592592592 +-5");
  t.assert.withinRange(t.getSprite("Pirat").y, -68.5925925925926, 5, "Expected Sprite Pirat to have y-position -68.5925925925926 +-5");
  ...
  t.assert.withinRange(t.getSprite("Pirat").size, 48, 1, "Expected Sprite Pirat to have size 48 +-1");
  ...
  t.assert.equal(t.getSprite("Schatztruhe").layerOrder, 2, "Expected Sprite Schatztruhe to be at layer 2");
  t.assert.equal(t.getSprite("Mädchen").layerOrder, 5, "Expected Sprite Mädchen to be at layer 5");
  t.assert.withinRange(t.getSprite("Pirat").x, -16.851851851851848, 5, "Expected Sprite Pirat to have x-position -16.851851851851848 +-5");
  t.assert.withinRange(t.getSprite("Pirat").y, -68.98518518518519, 5, "Expected Sprite Pirat to have y-position -68.98518518518519 +-5");
  t.assert.withinRange(t.getSprite("Schatzkarte").x, 0, 5, "Expected Sprite Schatzkarte to have x-position 0 +-5");
  t.assert.withinRange(t.getSprite("Schatzkarte").y, -20, 5, "Expected Sprite Schatzkarte to have y-position -20 +-5");
  t.assert.withinRange(t.getSprite("Vulkaninsel").x, -58, 5, "Expected Sprite Vulkaninsel to have x-position -58 +-5");
  t.assert.withinRange(t.getSprite("Vulkaninsel").y, 10, 5, "Expected Sprite Vulkaninsel to have y-position 10 +-5");
  ...
  t.assert.equal(t.getSprite("Schatztruhe").layerOrder, 2, "Expected Sprite Schatztruhe to be at layer 2");
  t.assert.equal(t.getSprite("Mädchen").layerOrder, 5, "Expected Sprite Mädchen to be at layer 5");
  t.assert.withinRange(t.getSprite("Pirat").x, 69.25925925925927, 5, "Expected Sprite Pirat to have x-position 69.25925925925927 +-5");
  t.assert.withinRange(t.getSprite("Pirat").y, -69.67407407407407, 5, "Expected Sprite Pirat to have y-position -69.67407407407407 +-5");
  t.assert.withinRange(t.getSprite("Schatzkarte").x, 0, 5, "Expected Sprite Schatzkarte to have x-position 0 +-5");
  t.assert.withinRange(t.getSprite("Schatzkarte").y, -20, 5, "Expected Sprite Schatzkarte to have y-position -20 +-5");
  t.assert.withinRange(t.getSprite("Vulkaninsel").x, -58, 5, "Expected Sprite Vulkaninsel to have x-position -58 +-5");
  t.assert.withinRange(t.getSprite("Vulkaninsel").y, 10, 5, "Expected Sprite Vulkaninsel to have y-position 10 +-5");
  ...
  t.assert.equal(t.getSprite("Schatztruhe").layerOrder, 2, "Expected Sprite Schatztruhe to be at layer 2");
  t.assert.equal(t.getSprite("Mädchen").layerOrder, 5, "Expected Sprite Mädchen to be at layer 5");
  t.assert.withinRange(t.getSprite("Pirat").x, 105.37037037037038, 5, "Expected Sprite Pirat to have x-position 105.37037037037038 +-5");
  t.assert.withinRange(t.getSprite("Pirat").y, -69.96296296296296, 5, "Expected Sprite Pirat to have y-position -69.96296296296296 +-5");
  t.assert.withinRange(t.getSprite("Schatzkarte").x, 0, 5, "Expected Sprite Schatzkarte to have x-position 0 +-5");
  t.assert.withinRange(t.getSprite("Schatzkarte").y, -20, 5, "Expected Sprite Schatzkarte to have y-position -20 +-5");
  t.assert.withinRange(t.getSprite("Vulkaninsel").x, -58, 5, "Expected Sprite Vulkaninsel to have x-position -58 +-5");
  t.assert.withinRange(t.getSprite("Vulkaninsel").y, 10, 5, "Expected Sprite Vulkaninsel to have y-position 10 +-5");
